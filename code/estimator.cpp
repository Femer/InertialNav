...
// Perform sequential fusion of optical flow measurements only when in the air and tilt is less than 30 deg.
    if (useOpticalFlow && (fuseOptData || obsIndex == 1) && !onGround && Tbn.z.z > 0.866f)
    {
        ...
        if (fuseOptData)
        {
            ...
            printf("Xpred=%5.2f, Xmea=%5.2f, Ypred=%5.2f, Ymea=%5.2f\n", losPred[0], losData[0], losPred[1], losData[1]);
            ...
            // Calculate observation jacobians
            SH_LOS[0] = vd*(a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3)) - ve*(a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3)) + vn*(a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3));
            SH_LOS[1] = ve*(a1*(2*q0*q1 - 2*q2*q3) + a3*(2*q0*q3 + 2*q1*q2) - sq(q0) + sq(q1) - sq(q2) + sq(q3)) - vd*(a1*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q1 + 2*q2*q3 + a3*(2*q0*q2 - 2*q1*q3)) + vn*(a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3));
            SH_LOS[2] = a1*(2*q0*q1 + 2*q2*q3) + a2*(2*q0*q2 - 2*q1*q3) - sq(q0) + sq(q1) + sq(q2) - sq(q3);
            SH_LOS[3] = 1/(pd - ptd);
            SH_LOS[4] = 2*q2 + 2*a1*q3 - 2*a3*q1;
            SH_LOS[5] = 2*a2*q2 - 2*q0 + 2*a3*q3;
            SH_LOS[6] = 1/sq(pd - ptd);
            SH_LOS[7] = 2*q3 - 2*a1*q2 + 2*a3*q0;
            SH_LOS[8] = 2*a1*q1 - 2*q0 + 2*a3*q3;

            for (uint8_t i = 0; i < n_states; i++) H_LOS[i] = 0;
            H_LOS[0] = -Kopt*(SH_LOS[2]*SH_LOS[3]*(ve*SH_LOS[8] + vn*SH_LOS[7] - vd*(2*q1 + 2*a1*q0 + 2*a3*q2)) + SH_LOS[1]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2));
            H_LOS[1] = -Kopt*(SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[8] - vn*SH_LOS[4] + ve*(2*q1 + 2*a1*q0 + 2*a3*q2)) + SH_LOS[1]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3));
            H_LOS[2] = Kopt*(SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[7] + ve*SH_LOS[4] + vn*(2*q1 + 2*a1*q0 + 2*a3*q2)) - SH_LOS[1]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3));
            H_LOS[3] = Kopt*(SH_LOS[1]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) + SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[4] - ve*SH_LOS[7] + vn*SH_LOS[8]));
            H_LOS[4] = -Kopt*SH_LOS[2]*SH_LOS[3]*(a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3));
            H_LOS[5] = -Kopt*SH_LOS[2]*SH_LOS[3]*(a1*(2*q0*q1 - 2*q2*q3) + a3*(2*q0*q3 + 2*q1*q2) - sq(q0) + sq(q1) - sq(q2) + sq(q3));
            H_LOS[6] = Kopt*SH_LOS[2]*SH_LOS[3]*(a1*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q1 + 2*q2*q3 + a3*(2*q0*q2 - 2*q1*q3));
            H_LOS[9] = Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[6];
            H_LOS[10] = Kopt/dt;
            H_LOS[11] = (Kopt*a3)/dt;
            H_LOS[12] = -(Kopt*a2)/dt;
            H_LOS[22] = -Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[6];
            H_LOS[23] = - (delAng.x + a3*(delAng.y) - a2*(delAng.z))/dt - SH_LOS[1]*SH_LOS[2]*SH_LOS[3];

            // Calculate Kalman gain
            SKK_LOS[0] = SH_LOS[0]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3) - SH_LOS[2]*SH_LOS[3]*(vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + ve*(2*q2 + 2*a2*q0 - 2*a3*q1) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2));
            SKK_LOS[1] = SH_LOS[2]*SH_LOS[3]*(ve*SH_LOS[5] - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0)) - SH_LOS[0]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1);
            SKK_LOS[2] = SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[5] + ve*(2*q1 - 2*a2*q3 + 2*a3*q2) - vn*(2*q2 + 2*a2*q0 - 2*a3*q1)) - SH_LOS[0]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3);
            SKK_LOS[3] = SH_LOS[2]*SH_LOS[3]*(vn*SH_LOS[5] + vd*(2*q2 + 2*a2*q0 - 2*a3*q1) - ve*(2*q3 + 2*a2*q1 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2);
            SKK_LOS[4] = SH_LOS[2]*SH_LOS[3]*(ve*SH_LOS[8] + vn*SH_LOS[7] - vd*(2*q1 + 2*a1*q0 + 2*a3*q2)) + SH_LOS[1]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2);
            SKK_LOS[5] = SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[8] - vn*SH_LOS[4] + ve*(2*q1 + 2*a1*q0 + 2*a3*q2)) + SH_LOS[1]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3);
            SKK_LOS[6] = SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[7] + ve*SH_LOS[4] + vn*(2*q1 + 2*a1*q0 + 2*a3*q2)) - SH_LOS[1]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3);
            SKK_LOS[7] = a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3);
            SKK_LOS[8] = a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3);
            SKK_LOS[9] = a1*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q1 + 2*q2*q3 + a3*(2*q0*q2 - 2*q1*q3);
            SKK_LOS[10] = a1*(2*q0*q1 - 2*q2*q3) + a3*(2*q0*q3 + 2*q1*q2) - sq(q0) + sq(q1) - sq(q2) + sq(q3);
            SKK_LOS[11] = a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3);
            SKK_LOS[12] = a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3);
            SKK_LOS[13] = SH_LOS[1]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) + SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[4] - ve*SH_LOS[7] + vn*SH_LOS[8]);
            SKK_LOS[14] = (delAng.y - a3*(delAng.x) + a1*(delAng.z))/dt - SH_LOS[0]*SH_LOS[2]*SH_LOS[3];
            SKK_LOS[15] = (delAng.x + a3*(delAng.y) - a2*(delAng.z))/dt + SH_LOS[1]*SH_LOS[2]*SH_LOS[3];
            SKK_LOS[16] = 1/dt;

            SK_LOS[0] = 1/(R_LOS - SKK_LOS[14]*(Kopt*P[0][23]*SKK_LOS[3] - P[23][23]*SKK_LOS[14] + Kopt*P[1][23]*SKK_LOS[0] - Kopt*P[2][23]*SKK_LOS[2] + Kopt*P[3][23]*SKK_LOS[1] + Kopt*P[11][23]*SKK_LOS[16] - Kopt*P[10][23]*a3*SKK_LOS[16] + Kopt*P[12][23]*a1*SKK_LOS[16] - Kopt*P[9][23]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][23]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[3]*(Kopt*P[0][0]*SKK_LOS[3] - P[23][0]*SKK_LOS[14] + Kopt*P[1][0]*SKK_LOS[0] - Kopt*P[2][0]*SKK_LOS[2] + Kopt*P[3][0]*SKK_LOS[1] + Kopt*P[11][0]*SKK_LOS[16] - Kopt*P[10][0]*a3*SKK_LOS[16] + Kopt*P[12][0]*a1*SKK_LOS[16] - Kopt*P[9][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[0]*(Kopt*P[0][1]*SKK_LOS[3] - P[23][1]*SKK_LOS[14] + Kopt*P[1][1]*SKK_LOS[0] - Kopt*P[2][1]*SKK_LOS[2] + Kopt*P[3][1]*SKK_LOS[1] + Kopt*P[11][1]*SKK_LOS[16] - Kopt*P[10][1]*a3*SKK_LOS[16] + Kopt*P[12][1]*a1*SKK_LOS[16] - Kopt*P[9][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SKK_LOS[2]*(Kopt*P[0][2]*SKK_LOS[3] - P[23][2]*SKK_LOS[14] + Kopt*P[1][2]*SKK_LOS[0] - Kopt*P[2][2]*SKK_LOS[2] + Kopt*P[3][2]*SKK_LOS[1] + Kopt*P[11][2]*SKK_LOS[16] - Kopt*P[10][2]*a3*SKK_LOS[16] + Kopt*P[12][2]*a1*SKK_LOS[16] - Kopt*P[9][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[1]*(Kopt*P[0][3]*SKK_LOS[3] - P[23][3]*SKK_LOS[14] + Kopt*P[1][3]*SKK_LOS[0] - Kopt*P[2][3]*SKK_LOS[2] + Kopt*P[3][3]*SKK_LOS[1] + Kopt*P[11][3]*SKK_LOS[16] - Kopt*P[10][3]*a3*SKK_LOS[16] + Kopt*P[12][3]*a1*SKK_LOS[16] - Kopt*P[9][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[16]*(Kopt*P[0][11]*SKK_LOS[3] - P[23][11]*SKK_LOS[14] + Kopt*P[1][11]*SKK_LOS[0] - Kopt*P[2][11]*SKK_LOS[2] + Kopt*P[3][11]*SKK_LOS[1] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[10][11]*a3*SKK_LOS[16] + Kopt*P[12][11]*a1*SKK_LOS[16] - Kopt*P[9][11]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][11]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*a3*SKK_LOS[16]*(Kopt*P[0][10]*SKK_LOS[3] - P[23][10]*SKK_LOS[14] + Kopt*P[1][10]*SKK_LOS[0] - Kopt*P[2][10]*SKK_LOS[2] + Kopt*P[3][10]*SKK_LOS[1] + Kopt*P[11][10]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[12][10]*a1*SKK_LOS[16] - Kopt*P[9][10]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][10]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*a1*SKK_LOS[16]*(Kopt*P[0][12]*SKK_LOS[3] - P[23][12]*SKK_LOS[14] + Kopt*P[1][12]*SKK_LOS[0] - Kopt*P[2][12]*SKK_LOS[2] + Kopt*P[3][12]*SKK_LOS[1] + Kopt*P[11][12]*SKK_LOS[16] - Kopt*P[10][12]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] - Kopt*P[9][12]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][12]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6]*(Kopt*P[0][9]*SKK_LOS[3] - P[23][9]*SKK_LOS[14] + Kopt*P[1][9]*SKK_LOS[0] - Kopt*P[2][9]*SKK_LOS[2] + Kopt*P[3][9]*SKK_LOS[1] + Kopt*P[11][9]*SKK_LOS[16] - Kopt*P[10][9]*a3*SKK_LOS[16] + Kopt*P[12][9]*a1*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6]*(Kopt*P[0][22]*SKK_LOS[3] - P[23][22]*SKK_LOS[14] + Kopt*P[1][22]*SKK_LOS[0] - Kopt*P[2][22]*SKK_LOS[2] + Kopt*P[3][22]*SKK_LOS[1] + Kopt*P[11][22]*SKK_LOS[16] - Kopt*P[10][22]*a3*SKK_LOS[16] + Kopt*P[12][22]*a1*SKK_LOS[16] - Kopt*P[9][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12]*(Kopt*P[0][4]*SKK_LOS[3] - P[23][4]*SKK_LOS[14] + Kopt*P[1][4]*SKK_LOS[0] - Kopt*P[2][4]*SKK_LOS[2] + Kopt*P[3][4]*SKK_LOS[1] + Kopt*P[11][4]*SKK_LOS[16] - Kopt*P[10][4]*a3*SKK_LOS[16] + Kopt*P[12][4]*a1*SKK_LOS[16] - Kopt*P[9][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11]*(Kopt*P[0][5]*SKK_LOS[3] - P[23][5]*SKK_LOS[14] + Kopt*P[1][5]*SKK_LOS[0] - Kopt*P[2][5]*SKK_LOS[2] + Kopt*P[3][5]*SKK_LOS[1] + Kopt*P[11][5]*SKK_LOS[16] - Kopt*P[10][5]*a3*SKK_LOS[16] + Kopt*P[12][5]*a1*SKK_LOS[16] - Kopt*P[9][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]*(Kopt*P[0][6]*SKK_LOS[3] - P[23][6]*SKK_LOS[14] + Kopt*P[1][6]*SKK_LOS[0] - Kopt*P[2][6]*SKK_LOS[2] + Kopt*P[3][6]*SKK_LOS[1] + Kopt*P[11][6]*SKK_LOS[16] - Kopt*P[10][6]*a3*SKK_LOS[16] + Kopt*P[12][6]*a1*SKK_LOS[16] - Kopt*P[9][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]));
            SK_LOS[1] = 1/(R_LOS + SKK_LOS[15]*(P[23][23]*SKK_LOS[15] + Kopt*P[0][23]*SKK_LOS[4] + Kopt*P[1][23]*SKK_LOS[5] - Kopt*P[2][23]*SKK_LOS[6] - Kopt*P[3][23]*SKK_LOS[13] - Kopt*P[10][23]*SKK_LOS[16] - Kopt*P[11][23]*a3*SKK_LOS[16] + Kopt*P[12][23]*a2*SKK_LOS[16] - Kopt*P[9][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*SKK_LOS[4]*(P[23][0]*SKK_LOS[15] + Kopt*P[0][0]*SKK_LOS[4] + Kopt*P[1][0]*SKK_LOS[5] - Kopt*P[2][0]*SKK_LOS[6] - Kopt*P[3][0]*SKK_LOS[13] - Kopt*P[10][0]*SKK_LOS[16] - Kopt*P[11][0]*a3*SKK_LOS[16] + Kopt*P[12][0]*a2*SKK_LOS[16] - Kopt*P[9][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*SKK_LOS[5]*(P[23][1]*SKK_LOS[15] + Kopt*P[0][1]*SKK_LOS[4] + Kopt*P[1][1]*SKK_LOS[5] - Kopt*P[2][1]*SKK_LOS[6] - Kopt*P[3][1]*SKK_LOS[13] - Kopt*P[10][1]*SKK_LOS[16] - Kopt*P[11][1]*a3*SKK_LOS[16] + Kopt*P[12][1]*a2*SKK_LOS[16] - Kopt*P[9][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*SKK_LOS[6]*(P[23][2]*SKK_LOS[15] + Kopt*P[0][2]*SKK_LOS[4] + Kopt*P[1][2]*SKK_LOS[5] - Kopt*P[2][2]*SKK_LOS[6] - Kopt*P[3][2]*SKK_LOS[13] - Kopt*P[10][2]*SKK_LOS[16] - Kopt*P[11][2]*a3*SKK_LOS[16] + Kopt*P[12][2]*a2*SKK_LOS[16] - Kopt*P[9][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*SKK_LOS[13]*(P[23][3]*SKK_LOS[15] + Kopt*P[0][3]*SKK_LOS[4] + Kopt*P[1][3]*SKK_LOS[5] - Kopt*P[2][3]*SKK_LOS[6] - Kopt*P[3][3]*SKK_LOS[13] - Kopt*P[10][3]*SKK_LOS[16] - Kopt*P[11][3]*a3*SKK_LOS[16] + Kopt*P[12][3]*a2*SKK_LOS[16] - Kopt*P[9][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*SKK_LOS[16]*(P[23][10]*SKK_LOS[15] + Kopt*P[0][10]*SKK_LOS[4] + Kopt*P[1][10]*SKK_LOS[5] - Kopt*P[2][10]*SKK_LOS[6] - Kopt*P[3][10]*SKK_LOS[13] - Kopt*P[10][10]*SKK_LOS[16] - Kopt*P[11][10]*a3*SKK_LOS[16] + Kopt*P[12][10]*a2*SKK_LOS[16] - Kopt*P[9][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*a3*SKK_LOS[16]*(P[23][11]*SKK_LOS[15] + Kopt*P[0][11]*SKK_LOS[4] + Kopt*P[1][11]*SKK_LOS[5] - Kopt*P[2][11]*SKK_LOS[6] - Kopt*P[3][11]*SKK_LOS[13] - Kopt*P[10][11]*SKK_LOS[16] - Kopt*P[11][11]*a3*SKK_LOS[16] + Kopt*P[12][11]*a2*SKK_LOS[16] - Kopt*P[9][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*a2*SKK_LOS[16]*(P[23][12]*SKK_LOS[15] + Kopt*P[0][12]*SKK_LOS[4] + Kopt*P[1][12]*SKK_LOS[5] - Kopt*P[2][12]*SKK_LOS[6] - Kopt*P[3][12]*SKK_LOS[13] - Kopt*P[10][12]*SKK_LOS[16] - Kopt*P[11][12]*a3*SKK_LOS[16] + Kopt*P[12][12]*a2*SKK_LOS[16] - Kopt*P[9][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[6]*(P[23][9]*SKK_LOS[15] + Kopt*P[0][9]*SKK_LOS[4] + Kopt*P[1][9]*SKK_LOS[5] - Kopt*P[2][9]*SKK_LOS[6] - Kopt*P[3][9]*SKK_LOS[13] - Kopt*P[10][9]*SKK_LOS[16] - Kopt*P[11][9]*a3*SKK_LOS[16] + Kopt*P[12][9]*a2*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[6]*(P[23][22]*SKK_LOS[15] + Kopt*P[0][22]*SKK_LOS[4] + Kopt*P[1][22]*SKK_LOS[5] - Kopt*P[2][22]*SKK_LOS[6] - Kopt*P[3][22]*SKK_LOS[13] - Kopt*P[10][22]*SKK_LOS[16] - Kopt*P[11][22]*a3*SKK_LOS[16] + Kopt*P[12][22]*a2*SKK_LOS[16] - Kopt*P[9][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7]*(P[23][4]*SKK_LOS[15] + Kopt*P[0][4]*SKK_LOS[4] + Kopt*P[1][4]*SKK_LOS[5] - Kopt*P[2][4]*SKK_LOS[6] - Kopt*P[3][4]*SKK_LOS[13] - Kopt*P[10][4]*SKK_LOS[16] - Kopt*P[11][4]*a3*SKK_LOS[16] + Kopt*P[12][4]*a2*SKK_LOS[16] - Kopt*P[9][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10]*(P[23][5]*SKK_LOS[15] + Kopt*P[0][5]*SKK_LOS[4] + Kopt*P[1][5]*SKK_LOS[5] - Kopt*P[2][5]*SKK_LOS[6] - Kopt*P[3][5]*SKK_LOS[13] - Kopt*P[10][5]*SKK_LOS[16] - Kopt*P[11][5]*a3*SKK_LOS[16] + Kopt*P[12][5]*a2*SKK_LOS[16] - Kopt*P[9][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]) - Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]*(P[23][6]*SKK_LOS[15] + Kopt*P[0][6]*SKK_LOS[4] + Kopt*P[1][6]*SKK_LOS[5] - Kopt*P[2][6]*SKK_LOS[6] - Kopt*P[3][6]*SKK_LOS[13] - Kopt*P[10][6]*SKK_LOS[16] - Kopt*P[11][6]*a3*SKK_LOS[16] + Kopt*P[12][6]*a2*SKK_LOS[16] - Kopt*P[9][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]));

            Kfusion[0] = -SK_LOS[1]*(P[0][23]*SKK_LOS[15] + Kopt*P[0][0]*SKK_LOS[4] + Kopt*P[0][1]*SKK_LOS[5] - Kopt*P[0][2]*SKK_LOS[6] - Kopt*P[0][3]*SKK_LOS[13] - Kopt*P[0][10]*SKK_LOS[16] - Kopt*P[0][11]*a3*SKK_LOS[16] + Kopt*P[0][12]*a2*SKK_LOS[16] - Kopt*P[0][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[0][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[0][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[0][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[0][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[1] = -SK_LOS[1]*(P[1][23]*SKK_LOS[15] + Kopt*P[1][0]*SKK_LOS[4] + Kopt*P[1][1]*SKK_LOS[5] - Kopt*P[1][2]*SKK_LOS[6] - Kopt*P[1][3]*SKK_LOS[13] - Kopt*P[1][10]*SKK_LOS[16] - Kopt*P[1][11]*a3*SKK_LOS[16] + Kopt*P[1][12]*a2*SKK_LOS[16] - Kopt*P[1][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[1][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[1][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[1][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[1][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[2] = -SK_LOS[1]*(P[2][23]*SKK_LOS[15] + Kopt*P[2][0]*SKK_LOS[4] + Kopt*P[2][1]*SKK_LOS[5] - Kopt*P[2][2]*SKK_LOS[6] - Kopt*P[2][3]*SKK_LOS[13] - Kopt*P[2][10]*SKK_LOS[16] - Kopt*P[2][11]*a3*SKK_LOS[16] + Kopt*P[2][12]*a2*SKK_LOS[16] - Kopt*P[2][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[2][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[2][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[2][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[2][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[3] = -SK_LOS[1]*(P[3][23]*SKK_LOS[15] + Kopt*P[3][0]*SKK_LOS[4] + Kopt*P[3][1]*SKK_LOS[5] - Kopt*P[3][2]*SKK_LOS[6] - Kopt*P[3][3]*SKK_LOS[13] - Kopt*P[3][10]*SKK_LOS[16] - Kopt*P[3][11]*a3*SKK_LOS[16] + Kopt*P[3][12]*a2*SKK_LOS[16] - Kopt*P[3][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[3][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[3][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[3][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[3][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[4] = -SK_LOS[1]*(P[4][23]*SKK_LOS[15] + Kopt*P[4][0]*SKK_LOS[4] + Kopt*P[4][1]*SKK_LOS[5] - Kopt*P[4][2]*SKK_LOS[6] - Kopt*P[4][3]*SKK_LOS[13] - Kopt*P[4][10]*SKK_LOS[16] - Kopt*P[4][11]*a3*SKK_LOS[16] + Kopt*P[4][12]*a2*SKK_LOS[16] - Kopt*P[4][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[4][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[4][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[5] = -SK_LOS[1]*(P[5][23]*SKK_LOS[15] + Kopt*P[5][0]*SKK_LOS[4] + Kopt*P[5][1]*SKK_LOS[5] - Kopt*P[5][2]*SKK_LOS[6] - Kopt*P[5][3]*SKK_LOS[13] - Kopt*P[5][10]*SKK_LOS[16] - Kopt*P[5][11]*a3*SKK_LOS[16] + Kopt*P[5][12]*a2*SKK_LOS[16] - Kopt*P[5][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[5][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[5][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[5][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[5][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[6] = -SK_LOS[1]*(P[6][23]*SKK_LOS[15] + Kopt*P[6][0]*SKK_LOS[4] + Kopt*P[6][1]*SKK_LOS[5] - Kopt*P[6][2]*SKK_LOS[6] - Kopt*P[6][3]*SKK_LOS[13] - Kopt*P[6][10]*SKK_LOS[16] - Kopt*P[6][11]*a3*SKK_LOS[16] + Kopt*P[6][12]*a2*SKK_LOS[16] - Kopt*P[6][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[6][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[6][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[6][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[7] = -SK_LOS[1]*(P[7][23]*SKK_LOS[15] + Kopt*P[7][0]*SKK_LOS[4] + Kopt*P[7][1]*SKK_LOS[5] - Kopt*P[7][2]*SKK_LOS[6] - Kopt*P[7][3]*SKK_LOS[13] - Kopt*P[7][10]*SKK_LOS[16] - Kopt*P[7][11]*a3*SKK_LOS[16] + Kopt*P[7][12]*a2*SKK_LOS[16] - Kopt*P[7][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[7][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[7][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[7][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[7][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[8] = -SK_LOS[1]*(P[8][23]*SKK_LOS[15] + Kopt*P[8][0]*SKK_LOS[4] + Kopt*P[8][1]*SKK_LOS[5] - Kopt*P[8][2]*SKK_LOS[6] - Kopt*P[8][3]*SKK_LOS[13] - Kopt*P[8][10]*SKK_LOS[16] - Kopt*P[8][11]*a3*SKK_LOS[16] + Kopt*P[8][12]*a2*SKK_LOS[16] - Kopt*P[8][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[8][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[8][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[8][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[8][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[9] = -SK_LOS[1]*(P[9][23]*SKK_LOS[15] + Kopt*P[9][0]*SKK_LOS[4] + Kopt*P[9][1]*SKK_LOS[5] - Kopt*P[9][2]*SKK_LOS[6] - Kopt*P[9][3]*SKK_LOS[13] - Kopt*P[9][10]*SKK_LOS[16] - Kopt*P[9][11]*a3*SKK_LOS[16] + Kopt*P[9][12]*a2*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[9][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[9][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[9][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[9][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[10] = -SK_LOS[1]*(P[10][23]*SKK_LOS[15] + Kopt*P[10][0]*SKK_LOS[4] + Kopt*P[10][1]*SKK_LOS[5] - Kopt*P[10][2]*SKK_LOS[6] - Kopt*P[10][3]*SKK_LOS[13] - Kopt*P[10][10]*SKK_LOS[16] - Kopt*P[10][11]*a3*SKK_LOS[16] + Kopt*P[10][12]*a2*SKK_LOS[16] - Kopt*P[10][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[10][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[10][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[10][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[10][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[11] = -SK_LOS[1]*(P[11][23]*SKK_LOS[15] + Kopt*P[11][0]*SKK_LOS[4] + Kopt*P[11][1]*SKK_LOS[5] - Kopt*P[11][2]*SKK_LOS[6] - Kopt*P[11][3]*SKK_LOS[13] - Kopt*P[11][10]*SKK_LOS[16] - Kopt*P[11][11]*a3*SKK_LOS[16] + Kopt*P[11][12]*a2*SKK_LOS[16] - Kopt*P[11][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[11][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[11][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[11][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[11][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[12] = -SK_LOS[1]*(P[12][23]*SKK_LOS[15] + Kopt*P[12][0]*SKK_LOS[4] + Kopt*P[12][1]*SKK_LOS[5] - Kopt*P[12][2]*SKK_LOS[6] - Kopt*P[12][3]*SKK_LOS[13] - Kopt*P[12][10]*SKK_LOS[16] - Kopt*P[12][11]*a3*SKK_LOS[16] + Kopt*P[12][12]*a2*SKK_LOS[16] - Kopt*P[12][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[12][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[12][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[12][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[12][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[13] = 0.0f;//-SK_LOS[1]*(P[13][23]*SKK_LOS[15] + Kopt*P[13][0]*SKK_LOS[4] + Kopt*P[13][1]*SKK_LOS[5] - Kopt*P[13][2]*SKK_LOS[6] - Kopt*P[13][3]*SKK_LOS[13] - Kopt*P[13][10]*SKK_LOS[16] - Kopt*P[13][11]*a3*SKK_LOS[16] + Kopt*P[13][12]*a2*SKK_LOS[16] - Kopt*P[13][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[13][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[13][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[13][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[13][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[14] = -SK_LOS[1]*(P[14][23]*SKK_LOS[15] + Kopt*P[14][0]*SKK_LOS[4] + Kopt*P[14][1]*SKK_LOS[5] - Kopt*P[14][2]*SKK_LOS[6] - Kopt*P[14][3]*SKK_LOS[13] - Kopt*P[14][10]*SKK_LOS[16] - Kopt*P[14][11]*a3*SKK_LOS[16] + Kopt*P[14][12]*a2*SKK_LOS[16] - Kopt*P[14][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[14][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[14][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[14][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[14][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[15] = -SK_LOS[1]*(P[15][23]*SKK_LOS[15] + Kopt*P[15][0]*SKK_LOS[4] + Kopt*P[15][1]*SKK_LOS[5] - Kopt*P[15][2]*SKK_LOS[6] - Kopt*P[15][3]*SKK_LOS[13] - Kopt*P[15][10]*SKK_LOS[16] - Kopt*P[15][11]*a3*SKK_LOS[16] + Kopt*P[15][12]*a2*SKK_LOS[16] - Kopt*P[15][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[15][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[15][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[15][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[15][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[16] = -SK_LOS[1]*(P[16][23]*SKK_LOS[15] + Kopt*P[16][0]*SKK_LOS[4] + Kopt*P[16][1]*SKK_LOS[5] - Kopt*P[16][2]*SKK_LOS[6] - Kopt*P[16][3]*SKK_LOS[13] - Kopt*P[16][10]*SKK_LOS[16] - Kopt*P[16][11]*a3*SKK_LOS[16] + Kopt*P[16][12]*a2*SKK_LOS[16] - Kopt*P[16][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[16][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[16][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[16][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[16][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[17] = -SK_LOS[1]*(P[17][23]*SKK_LOS[15] + Kopt*P[17][0]*SKK_LOS[4] + Kopt*P[17][1]*SKK_LOS[5] - Kopt*P[17][2]*SKK_LOS[6] - Kopt*P[17][3]*SKK_LOS[13] - Kopt*P[17][10]*SKK_LOS[16] - Kopt*P[17][11]*a3*SKK_LOS[16] + Kopt*P[17][12]*a2*SKK_LOS[16] - Kopt*P[17][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[17][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[17][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[17][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[17][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[18] = -SK_LOS[1]*(P[18][23]*SKK_LOS[15] + Kopt*P[18][0]*SKK_LOS[4] + Kopt*P[18][1]*SKK_LOS[5] - Kopt*P[18][2]*SKK_LOS[6] - Kopt*P[18][3]*SKK_LOS[13] - Kopt*P[18][10]*SKK_LOS[16] - Kopt*P[18][11]*a3*SKK_LOS[16] + Kopt*P[18][12]*a2*SKK_LOS[16] - Kopt*P[18][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[18][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[18][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[18][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[18][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[19] = -SK_LOS[1]*(P[19][23]*SKK_LOS[15] + Kopt*P[19][0]*SKK_LOS[4] + Kopt*P[19][1]*SKK_LOS[5] - Kopt*P[19][2]*SKK_LOS[6] - Kopt*P[19][3]*SKK_LOS[13] - Kopt*P[19][10]*SKK_LOS[16] - Kopt*P[19][11]*a3*SKK_LOS[16] + Kopt*P[19][12]*a2*SKK_LOS[16] - Kopt*P[19][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[19][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[19][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[19][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[19][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[20] = -SK_LOS[1]*(P[20][23]*SKK_LOS[15] + Kopt*P[20][0]*SKK_LOS[4] + Kopt*P[20][1]*SKK_LOS[5] - Kopt*P[20][2]*SKK_LOS[6] - Kopt*P[20][3]*SKK_LOS[13] - Kopt*P[20][10]*SKK_LOS[16] - Kopt*P[20][11]*a3*SKK_LOS[16] + Kopt*P[20][12]*a2*SKK_LOS[16] - Kopt*P[20][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[20][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[20][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[20][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[20][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[21] = -SK_LOS[1]*(P[21][23]*SKK_LOS[15] + Kopt*P[21][0]*SKK_LOS[4] + Kopt*P[21][1]*SKK_LOS[5] - Kopt*P[21][2]*SKK_LOS[6] - Kopt*P[21][3]*SKK_LOS[13] - Kopt*P[21][10]*SKK_LOS[16] - Kopt*P[21][11]*a3*SKK_LOS[16] + Kopt*P[21][12]*a2*SKK_LOS[16] - Kopt*P[21][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[21][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[21][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[21][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[21][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[22] = -SK_LOS[1]*(P[22][23]*SKK_LOS[15] + Kopt*P[22][0]*SKK_LOS[4] + Kopt*P[22][1]*SKK_LOS[5] - Kopt*P[22][2]*SKK_LOS[6] - Kopt*P[22][3]*SKK_LOS[13] - Kopt*P[22][10]*SKK_LOS[16] - Kopt*P[22][11]*a3*SKK_LOS[16] + Kopt*P[22][12]*a2*SKK_LOS[16] - Kopt*P[22][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[22][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[22][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
            Kfusion[23] = -SK_LOS[1]*(P[23][23]*SKK_LOS[15] + Kopt*P[23][0]*SKK_LOS[4] + Kopt*P[23][1]*SKK_LOS[5] - Kopt*P[23][2]*SKK_LOS[6] - Kopt*P[23][3]*SKK_LOS[13] - Kopt*P[23][10]*SKK_LOS[16] - Kopt*P[23][11]*a3*SKK_LOS[16] + Kopt*P[23][12]*a2*SKK_LOS[16] - Kopt*P[23][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[23][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[6] + Kopt*P[23][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[7] + Kopt*P[23][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[23][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[9]);
        ...
        else if (obsIndex == 1) // we are now fusing the Y measurement
        {
            // Calculate observation jacobians
            for (uint8_t i = 0; i < n_states; i++) H_LOS[i] = 0;
            H_LOS[0] = Kopt*(SH_LOS[2]*SH_LOS[3]*(vn*SH_LOS[5] + vd*(2*q2 + 2*a2*q0 - 2*a3*q1) - ve*(2*q3 + 2*a2*q1 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2));
            H_LOS[1] = Kopt*(SH_LOS[0]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3) - SH_LOS[2]*SH_LOS[3]*(vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + ve*(2*q2 + 2*a2*q0 - 2*a3*q1) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)));
            H_LOS[2] = -Kopt*(SH_LOS[2]*SH_LOS[3]*(vd*SH_LOS[5] + ve*(2*q1 - 2*a2*q3 + 2*a3*q2) - vn*(2*q2 + 2*a2*q0 - 2*a3*q1)) - SH_LOS[0]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3));
            H_LOS[3] = Kopt*(SH_LOS[2]*SH_LOS[3]*(ve*SH_LOS[5] - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0)) - SH_LOS[0]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1));
            H_LOS[4] = Kopt*SH_LOS[2]*SH_LOS[3]*(a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3));
            H_LOS[5] = -Kopt*SH_LOS[2]*SH_LOS[3]*(a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3));
            H_LOS[6] = Kopt*SH_LOS[2]*SH_LOS[3]*(a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3));
            H_LOS[9] = -Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6];
            H_LOS[10] = -(Kopt*a3)/dt;
            H_LOS[11] = Kopt/dt;
            H_LOS[12] = (Kopt*a1)/dt;
            H_LOS[22] = Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6];
            H_LOS[23] = SH_LOS[0]*SH_LOS[2]*SH_LOS[3] - (delAng.y - a3*(delAng.x) + a1*(delAng.z))/dt;

            // Calculate Kalman gains
            Kfusion[0] = (Kopt*P[0][1]*SKK_LOS[0] - P[0][23]*SKK_LOS[14] + Kopt*P[0][0]*SKK_LOS[3] + Kopt*P[0][3]*SKK_LOS[1] - Kopt*P[0][2]*SKK_LOS[2] + Kopt*P[0][11]*SKK_LOS[16] - Kopt*P[0][10]*a3*SKK_LOS[16] + Kopt*P[0][12]*a1*SKK_LOS[16] - Kopt*P[0][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[0][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[0][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[0][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[0][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8])/(R_LOS - SKK_LOS[14]*(Kopt*P[0][23]*SKK_LOS[3] - P[23][23]*SKK_LOS[14] + Kopt*P[1][23]*SKK_LOS[0] - Kopt*P[2][23]*SKK_LOS[2] + Kopt*P[3][23]*SKK_LOS[1] + Kopt*P[11][23]*SKK_LOS[16] - Kopt*P[10][23]*a3*SKK_LOS[16] + Kopt*P[12][23]*a1*SKK_LOS[16] - Kopt*P[9][23]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][23]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][23]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[3]*(Kopt*P[0][0]*SKK_LOS[3] - P[23][0]*SKK_LOS[14] + Kopt*P[1][0]*SKK_LOS[0] - Kopt*P[2][0]*SKK_LOS[2] + Kopt*P[3][0]*SKK_LOS[1] + Kopt*P[11][0]*SKK_LOS[16] - Kopt*P[10][0]*a3*SKK_LOS[16] + Kopt*P[12][0]*a1*SKK_LOS[16] - Kopt*P[9][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][0]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][0]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[0]*(Kopt*P[0][1]*SKK_LOS[3] - P[23][1]*SKK_LOS[14] + Kopt*P[1][1]*SKK_LOS[0] - Kopt*P[2][1]*SKK_LOS[2] + Kopt*P[3][1]*SKK_LOS[1] + Kopt*P[11][1]*SKK_LOS[16] - Kopt*P[10][1]*a3*SKK_LOS[16] + Kopt*P[12][1]*a1*SKK_LOS[16] - Kopt*P[9][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][1]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][1]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SKK_LOS[2]*(Kopt*P[0][2]*SKK_LOS[3] - P[23][2]*SKK_LOS[14] + Kopt*P[1][2]*SKK_LOS[0] - Kopt*P[2][2]*SKK_LOS[2] + Kopt*P[3][2]*SKK_LOS[1] + Kopt*P[11][2]*SKK_LOS[16] - Kopt*P[10][2]*a3*SKK_LOS[16] + Kopt*P[12][2]*a1*SKK_LOS[16] - Kopt*P[9][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][2]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][2]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[1]*(Kopt*P[0][3]*SKK_LOS[3] - P[23][3]*SKK_LOS[14] + Kopt*P[1][3]*SKK_LOS[0] - Kopt*P[2][3]*SKK_LOS[2] + Kopt*P[3][3]*SKK_LOS[1] + Kopt*P[11][3]*SKK_LOS[16] - Kopt*P[10][3]*a3*SKK_LOS[16] + Kopt*P[12][3]*a1*SKK_LOS[16] - Kopt*P[9][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][3]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][3]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[16]*(Kopt*P[0][11]*SKK_LOS[3] - P[23][11]*SKK_LOS[14] + Kopt*P[1][11]*SKK_LOS[0] - Kopt*P[2][11]*SKK_LOS[2] + Kopt*P[3][11]*SKK_LOS[1] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[10][11]*a3*SKK_LOS[16] + Kopt*P[12][11]*a1*SKK_LOS[16] - Kopt*P[9][11]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][11]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][11]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*a3*SKK_LOS[16]*(Kopt*P[0][10]*SKK_LOS[3] - P[23][10]*SKK_LOS[14] + Kopt*P[1][10]*SKK_LOS[0] - Kopt*P[2][10]*SKK_LOS[2] + Kopt*P[3][10]*SKK_LOS[1] + Kopt*P[11][10]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[12][10]*a1*SKK_LOS[16] - Kopt*P[9][10]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][10]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][10]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*a1*SKK_LOS[16]*(Kopt*P[0][12]*SKK_LOS[3] - P[23][12]*SKK_LOS[14] + Kopt*P[1][12]*SKK_LOS[0] - Kopt*P[2][12]*SKK_LOS[2] + Kopt*P[3][12]*SKK_LOS[1] + Kopt*P[11][12]*SKK_LOS[16] - Kopt*P[10][12]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] - Kopt*P[9][12]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][12]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][12]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6]*(Kopt*P[0][9]*SKK_LOS[3] - P[23][9]*SKK_LOS[14] + Kopt*P[1][9]*SKK_LOS[0] - Kopt*P[2][9]*SKK_LOS[2] + Kopt*P[3][9]*SKK_LOS[1] + Kopt*P[11][9]*SKK_LOS[16] - Kopt*P[10][9]*a3*SKK_LOS[16] + Kopt*P[12][9]*a1*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][9]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[0]*SH_LOS[2]*SH_LOS[6]*(Kopt*P[0][22]*SKK_LOS[3] - P[23][22]*SKK_LOS[14] + Kopt*P[1][22]*SKK_LOS[0] - Kopt*P[2][22]*SKK_LOS[2] + Kopt*P[3][22]*SKK_LOS[1] + Kopt*P[11][22]*SKK_LOS[16] - Kopt*P[10][22]*a3*SKK_LOS[16] + Kopt*P[12][22]*a1*SKK_LOS[16] - Kopt*P[9][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][22]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12]*(Kopt*P[0][4]*SKK_LOS[3] - P[23][4]*SKK_LOS[14] + Kopt*P[1][4]*SKK_LOS[0] - Kopt*P[2][4]*SKK_LOS[2] + Kopt*P[3][4]*SKK_LOS[1] + Kopt*P[11][4]*SKK_LOS[16] - Kopt*P[10][4]*a3*SKK_LOS[16] + Kopt*P[12][4]*a1*SKK_LOS[16] - Kopt*P[9][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][4]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11]*(Kopt*P[0][5]*SKK_LOS[3] - P[23][5]*SKK_LOS[14] + Kopt*P[1][5]*SKK_LOS[0] - Kopt*P[2][5]*SKK_LOS[2] + Kopt*P[3][5]*SKK_LOS[1] + Kopt*P[11][5]*SKK_LOS[16] - Kopt*P[10][5]*a3*SKK_LOS[16] + Kopt*P[12][5]*a1*SKK_LOS[16] - Kopt*P[9][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][5]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]*(Kopt*P[0][6]*SKK_LOS[3] - P[23][6]*SKK_LOS[14] + Kopt*P[1][6]*SKK_LOS[0] - Kopt*P[2][6]*SKK_LOS[2] + Kopt*P[3][6]*SKK_LOS[1] + Kopt*P[11][6]*SKK_LOS[16] - Kopt*P[10][6]*a3*SKK_LOS[16] + Kopt*P[12][6]*a1*SKK_LOS[16] - Kopt*P[9][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][6]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]));
            Kfusion[1] = SK_LOS[0]*(Kopt*P[1][1]*SKK_LOS[0] - P[1][23]*SKK_LOS[14] + Kopt*P[1][0]*SKK_LOS[3] + Kopt*P[1][3]*SKK_LOS[1] - Kopt*P[1][2]*SKK_LOS[2] + Kopt*P[1][11]*SKK_LOS[16] - Kopt*P[1][10]*a3*SKK_LOS[16] + Kopt*P[1][12]*a1*SKK_LOS[16] - Kopt*P[1][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[1][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[1][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[1][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[1][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[2] = SK_LOS[0]*(Kopt*P[2][1]*SKK_LOS[0] - P[2][23]*SKK_LOS[14] + Kopt*P[2][0]*SKK_LOS[3] + Kopt*P[2][3]*SKK_LOS[1] - Kopt*P[2][2]*SKK_LOS[2] + Kopt*P[2][11]*SKK_LOS[16] - Kopt*P[2][10]*a3*SKK_LOS[16] + Kopt*P[2][12]*a1*SKK_LOS[16] - Kopt*P[2][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[2][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[2][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[2][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[2][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[3] = SK_LOS[0]*(Kopt*P[3][1]*SKK_LOS[0] - P[3][23]*SKK_LOS[14] + Kopt*P[3][0]*SKK_LOS[3] + Kopt*P[3][3]*SKK_LOS[1] - Kopt*P[3][2]*SKK_LOS[2] + Kopt*P[3][11]*SKK_LOS[16] - Kopt*P[3][10]*a3*SKK_LOS[16] + Kopt*P[3][12]*a1*SKK_LOS[16] - Kopt*P[3][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[3][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[3][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[3][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[3][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[4] = SK_LOS[0]*(Kopt*P[4][1]*SKK_LOS[0] - P[4][23]*SKK_LOS[14] + Kopt*P[4][0]*SKK_LOS[3] + Kopt*P[4][3]*SKK_LOS[1] - Kopt*P[4][2]*SKK_LOS[2] + Kopt*P[4][11]*SKK_LOS[16] - Kopt*P[4][10]*a3*SKK_LOS[16] + Kopt*P[4][12]*a1*SKK_LOS[16] - Kopt*P[4][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[4][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[4][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[4][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[5] = SK_LOS[0]*(Kopt*P[5][1]*SKK_LOS[0] - P[5][23]*SKK_LOS[14] + Kopt*P[5][0]*SKK_LOS[3] + Kopt*P[5][3]*SKK_LOS[1] - Kopt*P[5][2]*SKK_LOS[2] + Kopt*P[5][11]*SKK_LOS[16] - Kopt*P[5][10]*a3*SKK_LOS[16] + Kopt*P[5][12]*a1*SKK_LOS[16] - Kopt*P[5][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[5][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[5][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[5][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[6] = SK_LOS[0]*(Kopt*P[6][1]*SKK_LOS[0] - P[6][23]*SKK_LOS[14] + Kopt*P[6][0]*SKK_LOS[3] + Kopt*P[6][3]*SKK_LOS[1] - Kopt*P[6][2]*SKK_LOS[2] + Kopt*P[6][11]*SKK_LOS[16] - Kopt*P[6][10]*a3*SKK_LOS[16] + Kopt*P[6][12]*a1*SKK_LOS[16] - Kopt*P[6][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[6][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[6][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[6][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[7] = SK_LOS[0]*(Kopt*P[7][1]*SKK_LOS[0] - P[7][23]*SKK_LOS[14] + Kopt*P[7][0]*SKK_LOS[3] + Kopt*P[7][3]*SKK_LOS[1] - Kopt*P[7][2]*SKK_LOS[2] + Kopt*P[7][11]*SKK_LOS[16] - Kopt*P[7][10]*a3*SKK_LOS[16] + Kopt*P[7][12]*a1*SKK_LOS[16] - Kopt*P[7][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[7][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[7][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[7][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[7][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[8] = SK_LOS[0]*(Kopt*P[8][1]*SKK_LOS[0] - P[8][23]*SKK_LOS[14] + Kopt*P[8][0]*SKK_LOS[3] + Kopt*P[8][3]*SKK_LOS[1] - Kopt*P[8][2]*SKK_LOS[2] + Kopt*P[8][11]*SKK_LOS[16] - Kopt*P[8][10]*a3*SKK_LOS[16] + Kopt*P[8][12]*a1*SKK_LOS[16] - Kopt*P[8][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[8][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[8][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[8][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[8][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[9] = SK_LOS[0]*(Kopt*P[9][1]*SKK_LOS[0] - P[9][23]*SKK_LOS[14] + Kopt*P[9][0]*SKK_LOS[3] + Kopt*P[9][3]*SKK_LOS[1] - Kopt*P[9][2]*SKK_LOS[2] + Kopt*P[9][11]*SKK_LOS[16] - Kopt*P[9][10]*a3*SKK_LOS[16] + Kopt*P[9][12]*a1*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[9][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[9][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[9][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[9][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[10] = SK_LOS[0]*(Kopt*P[10][1]*SKK_LOS[0] - P[10][23]*SKK_LOS[14] + Kopt*P[10][0]*SKK_LOS[3] + Kopt*P[10][3]*SKK_LOS[1] - Kopt*P[10][2]*SKK_LOS[2] + Kopt*P[10][11]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[10][12]*a1*SKK_LOS[16] - Kopt*P[10][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[10][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[10][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[10][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[10][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[11] = SK_LOS[0]*(Kopt*P[11][1]*SKK_LOS[0] - P[11][23]*SKK_LOS[14] + Kopt*P[11][0]*SKK_LOS[3] + Kopt*P[11][3]*SKK_LOS[1] - Kopt*P[11][2]*SKK_LOS[2] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[11][10]*a3*SKK_LOS[16] + Kopt*P[11][12]*a1*SKK_LOS[16] - Kopt*P[11][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[11][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[11][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[11][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[11][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[12] = SK_LOS[0]*(Kopt*P[12][1]*SKK_LOS[0] - P[12][23]*SKK_LOS[14] + Kopt*P[12][0]*SKK_LOS[3] + Kopt*P[12][3]*SKK_LOS[1] - Kopt*P[12][2]*SKK_LOS[2] + Kopt*P[12][11]*SKK_LOS[16] - Kopt*P[12][10]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] - Kopt*P[12][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[12][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[12][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[12][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[12][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[13] = 0.0f;//SK_LOS[0]*(Kopt*P[13][1]*SKK_LOS[0] - P[13][23]*SKK_LOS[14] + Kopt*P[13][0]*SKK_LOS[3] + Kopt*P[13][3]*SKK_LOS[1] - Kopt*P[13][2]*SKK_LOS[2] + Kopt*P[13][11]*SKK_LOS[16] - Kopt*P[13][10]*a3*SKK_LOS[16] + Kopt*P[13][12]*a1*SKK_LOS[16] - Kopt*P[13][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[13][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[13][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[13][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[13][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[14] = SK_LOS[0]*(Kopt*P[14][1]*SKK_LOS[0] - P[14][23]*SKK_LOS[14] + Kopt*P[14][0]*SKK_LOS[3] + Kopt*P[14][3]*SKK_LOS[1] - Kopt*P[14][2]*SKK_LOS[2] + Kopt*P[14][11]*SKK_LOS[16] - Kopt*P[14][10]*a3*SKK_LOS[16] + Kopt*P[14][12]*a1*SKK_LOS[16] - Kopt*P[14][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[14][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[14][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[14][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[14][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[15] = SK_LOS[0]*(Kopt*P[15][1]*SKK_LOS[0] - P[15][23]*SKK_LOS[14] + Kopt*P[15][0]*SKK_LOS[3] + Kopt*P[15][3]*SKK_LOS[1] - Kopt*P[15][2]*SKK_LOS[2] + Kopt*P[15][11]*SKK_LOS[16] - Kopt*P[15][10]*a3*SKK_LOS[16] + Kopt*P[15][12]*a1*SKK_LOS[16] - Kopt*P[15][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[15][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[15][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[15][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[15][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[16] = SK_LOS[0]*(Kopt*P[16][1]*SKK_LOS[0] - P[16][23]*SKK_LOS[14] + Kopt*P[16][0]*SKK_LOS[3] + Kopt*P[16][3]*SKK_LOS[1] - Kopt*P[16][2]*SKK_LOS[2] + Kopt*P[16][11]*SKK_LOS[16] - Kopt*P[16][10]*a3*SKK_LOS[16] + Kopt*P[16][12]*a1*SKK_LOS[16] - Kopt*P[16][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[16][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[16][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[16][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[16][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[17] = SK_LOS[0]*(Kopt*P[17][1]*SKK_LOS[0] - P[17][23]*SKK_LOS[14] + Kopt*P[17][0]*SKK_LOS[3] + Kopt*P[17][3]*SKK_LOS[1] - Kopt*P[17][2]*SKK_LOS[2] + Kopt*P[17][11]*SKK_LOS[16] - Kopt*P[17][10]*a3*SKK_LOS[16] + Kopt*P[17][12]*a1*SKK_LOS[16] - Kopt*P[17][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[17][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[17][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[17][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[17][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[18] = SK_LOS[0]*(Kopt*P[18][1]*SKK_LOS[0] - P[18][23]*SKK_LOS[14] + Kopt*P[18][0]*SKK_LOS[3] + Kopt*P[18][3]*SKK_LOS[1] - Kopt*P[18][2]*SKK_LOS[2] + Kopt*P[18][11]*SKK_LOS[16] - Kopt*P[18][10]*a3*SKK_LOS[16] + Kopt*P[18][12]*a1*SKK_LOS[16] - Kopt*P[18][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[18][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[18][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[18][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[18][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[19] = SK_LOS[0]*(Kopt*P[19][1]*SKK_LOS[0] - P[19][23]*SKK_LOS[14] + Kopt*P[19][0]*SKK_LOS[3] + Kopt*P[19][3]*SKK_LOS[1] - Kopt*P[19][2]*SKK_LOS[2] + Kopt*P[19][11]*SKK_LOS[16] - Kopt*P[19][10]*a3*SKK_LOS[16] + Kopt*P[19][12]*a1*SKK_LOS[16] - Kopt*P[19][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[19][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[19][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[19][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[19][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[20] = SK_LOS[0]*(Kopt*P[20][1]*SKK_LOS[0] - P[20][23]*SKK_LOS[14] + Kopt*P[20][0]*SKK_LOS[3] + Kopt*P[20][3]*SKK_LOS[1] - Kopt*P[20][2]*SKK_LOS[2] + Kopt*P[20][11]*SKK_LOS[16] - Kopt*P[20][10]*a3*SKK_LOS[16] + Kopt*P[20][12]*a1*SKK_LOS[16] - Kopt*P[20][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[20][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[20][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[20][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[20][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[21] = SK_LOS[0]*(Kopt*P[21][1]*SKK_LOS[0] - P[21][23]*SKK_LOS[14] + Kopt*P[21][0]*SKK_LOS[3] + Kopt*P[21][3]*SKK_LOS[1] - Kopt*P[21][2]*SKK_LOS[2] + Kopt*P[21][11]*SKK_LOS[16] - Kopt*P[21][10]*a3*SKK_LOS[16] + Kopt*P[21][12]*a1*SKK_LOS[16] - Kopt*P[21][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[21][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[21][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[21][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[21][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[22] = SK_LOS[0]*(Kopt*P[22][1]*SKK_LOS[0] - P[22][23]*SKK_LOS[14] + Kopt*P[22][0]*SKK_LOS[3] + Kopt*P[22][3]*SKK_LOS[1] - Kopt*P[22][2]*SKK_LOS[2] + Kopt*P[22][11]*SKK_LOS[16] - Kopt*P[22][10]*a3*SKK_LOS[16] + Kopt*P[22][12]*a1*SKK_LOS[16] - Kopt*P[22][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[22][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[22][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[22][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
            Kfusion[23] = SK_LOS[0]*(Kopt*P[23][1]*SKK_LOS[0] - P[23][23]*SKK_LOS[14] + Kopt*P[23][0]*SKK_LOS[3] + Kopt*P[23][3]*SKK_LOS[1] - Kopt*P[23][2]*SKK_LOS[2] + Kopt*P[23][11]*SKK_LOS[16] - Kopt*P[23][10]*a3*SKK_LOS[16] + Kopt*P[23][12]*a1*SKK_LOS[16] - Kopt*P[23][9]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[23][22]*SH_LOS[0]*SH_LOS[2]*SH_LOS[6] + Kopt*P[23][4]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[12] - Kopt*P[23][5]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[23][6]*SH_LOS[2]*SH_LOS[3]*SKK_LOS[8]);
