...
// Save delta angle values used for fusion processes. These may be averaged or filtered later, so we use a separate varaible
    delAngForFusion[0] = correctedDelAng.x;
    delAngForFusion[1] = correctedDelAng.y;
    delAngForFusion[2] = correctedDelAng.z;
...
void AttPosEKF::CovariancePrediction(float dt)
{
    ...
    processNoise[23] = dt * optScaleSigma;
    ...
    nextP[0][23] = P[0][23] + P[1][23]*SF[7] + P[2][23]*SF[9] + P[3][23]*SF[8] + P[10][23]*SF[11] + P[11][23]*SPP[7] + P[12][23]*SPP[6];
    ...
    nextP[1][23] = P[1][23] + P[0][23]*SF[6] + P[2][23]*SF[5] + P[3][23]*SF[9] + P[11][23]*SPP[6] - P[12][23]*SPP[7] - (P[10][23]*q0)/2;
    ...
    nextP[2][23] = P[2][23] + P[0][23]*SF[4] + P[1][23]*SF[8] + P[3][23]*SF[6] + P[12][23]*SF[11] - P[10][23]*SPP[6] - (P[11][23]*q0)/2;
    ...
    nextP[3][23] = P[3][23] + P[0][23]*SF[5] + P[1][23]*SF[4] + P[2][23]*SF[7] - P[11][23]*SF[11] + P[10][23]*SPP[7] - (P[12][23]*q0)/2;
    ...
    nextP[4][23] = P[4][23] + P[0][23]*SF[3] + P[1][23]*SF[1] + P[2][23]*SPP[0] - P[3][23]*SPP[2] - P[13][23]*SPP[4];
    ...
    nextP[5][23] = P[5][23] + P[0][23]*SF[2] + P[2][23]*SF[1] + P[3][23]*SF[3] - P[1][23]*SPP[0] + P[13][23]*SPP[3];
    ...
    nextP[6][23] = P[6][23] + P[1][23]*SF[2] + P[3][23]*SF[1] + P[0][23]*SPP[0] - P[2][23]*SPP[1] - P[13][23]*SPP[5];
    ...
    nextP[22][10] = P[22][10];
    nextP[22][11] = P[22][11];
    nextP[22][12] = P[22][12];    SF[0] = dvz - dvz_b;
    SF[1] = 2*q3*SF[0] + 2*dvx*q1 + 2*dvy*q2;
    SF[2] = 2*dvx*q3 - 2*q1*SF[0] + 2*dvy*q0;
    SF[3] = 2*q2*SF[0] + 2*dvx*q0 - 2*dvy*q3;
    SF[4] = day/2 - day_b/2;
    ...
    nextP[21][20] = P[21][20];
    nextP[21][21] = P[21][21];
    nextP[21][22] = P[21][22];    SF[0] = dvz - dvz_b;
    SF[1] = 2*q3*SF[0] + 2*dvx*q1 + 2*dvy*q2;
    SF[2] = 2*dvx*q3 - 2*q1*SF[0] + 2*dvy*q0;
    SF[3] = 2*q2*SF[0] + 2*dvx*q0 - 2*dvy*q3;
    SF[4] = day/2 - day_b/2;
    ...
    nextP[22][22] = P[22][22];
    nextP[22][23] = P[22][23];
    nextP[23][0] = P[23][0] + P[23][1]*SF[7] + P[23][2]*SF[9] + P[23][3]*SF[8] + P[23][10]*SF[11] + P[23][11]*SPP[7] + P[23][12]*SPP[6];
    nextP[23][1] = P[23][1] + P[23][0]*SF[6] + P[23][2]*SF[5] + P[23][3]*SF[9] + P[23][11]*SPP[6] - P[23][12]*SPP[7] - (P[23][10]*q0)/2;
    nextP[23][2] = P[23][2] + P[23][0]*SF[4] + P[23][1]*SF[8] + P[23][3]*SF[6] + P[23][12]*SF[11] - P[23][10]*SPP[6] - (P[23][11]*q0)/2;
    nextP[23][3] = P[23][3] + P[23][0]*SF[5] + P[23][1]*SF[4] + P[23][2]*SF[7] - P[23][11]*SF[11] + P[23][10]*SPP[7] - (P[23][12]*q0)/2;
    nextP[23][4] = P[23][4] + P[23][1]*SF[1] + P[23][0]*SF[3] + P[23][2]*SPP[0] - P[23][3]*SPP[2] - P[23][13]*SPP[4];
    nextP[23][5] = P[23][5] + P[23][0]*SF[2] + P[23][2]*SF[1] + P[23][3]*SF[3] - P[23][1]*SPP[0] + P[23][13]*SPP[3];
    nextP[23][6] = P[23][6] + P[23][1]*SF[2] + P[23][3]*SF[1] + P[23][0]*SPP[0] - P[23][2]*SPP[1] - P[23][13]*SPP[5];
    ...
    // If on ground, inhibit terrain and optical flow scale factor updates by
    // setting the coresponding covariance terms to zero.
    if (onGround)
    {
...
// associated with sequential fusion
    if (useCompass && (fuseMagData || obsIndex == 1 || obsIndex == 2))
    {
        ...
        if (fuseMagData)
        {
            ...
            Kfusion[23] = SK_MX[0]*(P[23][19] + P[23][1]*SH_MAG[0] + P[23][3]*SH_MAG[2] + P[23][0]*SK_MX[3] - P[23][2]*SK_MX[2] - P[23][16]*SK_MX[1] + P[23][17]*SK_MX[5] - P[23][18]*SK_MX[4]);
        ...
        else if (obsIndex == 2) // we are now fusing the Z measurement
        {
            ...
            Kfusion[23] = SK_MZ[0]*(P[23][21] + P[23][0]*SH_MAG[1] + P[23][3]*SH_MAG[0] - P[23][1]*SK_MZ[2] + P[23][2]*SK_MZ[3] + P[23][18]*SK_MZ[1] + P[23][16]*SK_MZ[5] - P[23][17]*SK_MZ[4]);
...
void AttPosEKF::FuseAirspeed()
{
    ...
    if (useAirspeed && fuseVtasData && (VtasPred > 1.0f) && (VtasMeas > 8.0f))
    {
        ...
        Kfusion[23] = SK_TAS*(P[23][4]*SH_TAS[2] - P[23][14]*SH_TAS[2] + P[23][5]*SH_TAS[1] - P[23][15]*SH_TAS[1] + P[23][6]*vd*SH_TAS[0]);
        ...
        if ((innovVtas*innovVtas*SK_TAS) < 25.0)
        {
            ...
            for (uint8_t i = 0; i <= 23; i++)
            {
                ...
                for (uint8_t j = 16; j <= 23; j++) KH[i][j] = 0.0;
            }
            for (uint8_t i = 0; i <= 23; i++)
            {
                for (uint8_t j = 0; j <= 23; j++)
...
void AttPosEKF::FuseRangeFinder()
{
    ...
    float SK_RNG[6];
    float cosRngTilt;
    const float R_RNG = sq(0.1f + 0.05f * rngMea); // rangefinder measurement variance
...
void AttPosEKF::FuseOpticalFlow(float dt)
{
    static uint8_t obsIndex;
    static float SH_LOS[7];
    static float SKK_LOS[17];
...
// Perform sequential fusion of optical flow measurements only when in the air and tilt is less than 30 deg.
    if (useOpticalFlow && (fuseOptData || obsIndex == 1) && !onGround && Tbs.z.z > 0.866f && rngMea > 5.0f && rngMea < 39.0f)
    {
        ...
        if (fuseOptData)
        {
            ...
            ptd      = statesAtLosMeasTime[22];
            Kopt     = statesAtLosMeasTime[23];
            delAng.x  = statesAtLosMeasTime[24];
            delAng.y  = statesAtLosMeasTime[25];
            delAng.z  = statesAtLosMeasTime[26];
            velNED.x = vn;
            velNED.y = ve;
            velNED.z = vd;
            ...
            losPred[0] = Kopt * ( -relVelSensor.y/range - delAngRel.x/dt);
            losPred[1] = Kopt * (  relVelSensor.x/range - delAngRel.y/dt);
            ...
            SH_LOS[1] = a1*(2*q0*q1 + 2*q2*q3) + a2*(2*q0*q2 - 2*q1*q3) - sq(q0) + sq(q1) + sq(q2) - sq(q3);
            SH_LOS[2] = vd*(a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3)) - ve*(a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3)) + vn*(a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3));
            SH_LOS[3] = 1/(pd - ptd);
            SH_LOS[4] = 2*q2 + 2*a2*q0 - 2*a3*q1;
            SH_LOS[5] = 1/sq(pd - ptd);
            SH_LOS[6] = 2*a1*q1 - 2*q0 + 2*a3*q3;

            for (uint8_t i = 0; i < n_states; i++) H_LOS[i] = 0;
            H_LOS[0] = Kopt*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[6] - vd*(2*q1 + 2*a1*q0 + 2*a3*q2) + vn*(2*q3 - 2*a1*q2 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2));
            H_LOS[1] = Kopt*(SH_LOS[1]*SH_LOS[3]*(vd*SH_LOS[6] + ve*(2*q1 + 2*a1*q0 + 2*a3*q2) - vn*(2*q2 + 2*a1*q3 - 2*a3*q1)) + SH_LOS[0]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3));
            H_LOS[2] = Kopt*(SH_LOS[0]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3) - SH_LOS[1]*SH_LOS[3]*(vd*(2*q3 - 2*a1*q2 + 2*a3*q0) + ve*(2*q2 + 2*a1*q3 - 2*a3*q1) + vn*(2*q1 + 2*a1*q0 + 2*a3*q2)));
            H_LOS[3] = -Kopt*(SH_LOS[1]*SH_LOS[3]*(vn*SH_LOS[6] + vd*(2*q2 + 2*a1*q3 - 2*a3*q1) - ve*(2*q3 - 2*a1*q2 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1));
            H_LOS[4] = Kopt*SH_LOS[1]*SH_LOS[3]*(a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3));
            H_LOS[5] = Kopt*SH_LOS[1]*SH_LOS[3]*(a1*(2*q0*q1 - 2*q2*q3) + a3*(2*q0*q3 + 2*q1*q2) - sq(q0) + sq(q1) - sq(q2) + sq(q3));
            H_LOS[6] = -Kopt*SH_LOS[1]*SH_LOS[3]*(a1*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q1 + 2*q2*q3 + a3*(2*q0*q2 - 2*q1*q3));
            H_LOS[9] = -Kopt*SH_LOS[0]*SH_LOS[1]*SH_LOS[5];
            H_LOS[10] = Kopt/dt;
            H_LOS[11] = (Kopt*a3)/dt;
            H_LOS[12] = -(Kopt*a2)/dt;
            H_LOS[22] = Kopt*SH_LOS[0]*SH_LOS[1]*SH_LOS[5];
            H_LOS[23] = SH_LOS[0]*SH_LOS[1]*SH_LOS[3] - (delAng.x + a3*(delAng.y) - a2*(delAng.z))/dt;

            // Calculate Kalman gain
            SKK_LOS[0] = SH_LOS[0]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3) - SH_LOS[1]*SH_LOS[3]*(vd*(2*q3 - 2*a1*q2 + 2*a3*q0) + ve*(2*q2 + 2*a1*q3 - 2*a3*q1) + vn*(2*q1 + 2*a1*q0 + 2*a3*q2));
            SKK_LOS[1] = SH_LOS[1]*SH_LOS[3]*(vd*(2*a2*q2 - 2*q0 + 2*a3*q3) - vn*SH_LOS[4] + ve*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3);
            SKK_LOS[2] = SH_LOS[1]*SH_LOS[3]*(vn*SH_LOS[6] + vd*(2*q2 + 2*a1*q3 - 2*a3*q1) - ve*(2*q3 - 2*a1*q2 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1);
            SKK_LOS[3] = SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3);
            SKK_LOS[4] = SH_LOS[1]*SH_LOS[3]*(vd*SH_LOS[4] - ve*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*a2*q2 - 2*q0 + 2*a3*q3)) + SH_LOS[2]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2);
            SKK_LOS[5] = SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0));
            SKK_LOS[6] = SH_LOS[1]*SH_LOS[3]*(vd*SH_LOS[6] + ve*(2*q1 + 2*a1*q0 + 2*a3*q2) - vn*(2*q2 + 2*a1*q3 - 2*a3*q1)) + SH_LOS[0]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3);
            SKK_LOS[7] = SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[6] - vd*(2*q1 + 2*a1*q0 + 2*a3*q2) + vn*(2*q3 - 2*a1*q2 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2);
            SKK_LOS[8] = a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3);
            SKK_LOS[9] = a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3);
            SKK_LOS[10] = a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3);
            SKK_LOS[11] = a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3);
            SKK_LOS[12] = a1*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q1 + 2*q2*q3 + a3*(2*q0*q2 - 2*q1*q3);
            SKK_LOS[13] = a1*(2*q0*q1 - 2*q2*q3) + a3*(2*q0*q3 + 2*q1*q2) - sq(q0) + sq(q1) - sq(q2) + sq(q3);
            SKK_LOS[14] = (delAng.x + a3*(delAng.y) - a2*(delAng.z))/dt - SH_LOS[0]*SH_LOS[1]*SH_LOS[3];
            SKK_LOS[15] = (delAng.y - a3*(delAng.x) + a1*(delAng.z))/dt + SH_LOS[1]*SH_LOS[2]*SH_LOS[3];
            SKK_LOS[16] = 1/dt;

            SK_LOS[0] = 1/(R_LOS - SKK_LOS[14]*(Kopt*P[0][23]*SKK_LOS[7] - P[23][23]*SKK_LOS[14] + Kopt*P[1][23]*SKK_LOS[6] + Kopt*P[2][23]*SKK_LOS[0] - Kopt*P[3][23]*SKK_LOS[2] + Kopt*P[10][23]*SKK_LOS[16] + Kopt*P[11][23]*a3*SKK_LOS[16] - Kopt*P[12][23]*a2*SKK_LOS[16] - Kopt*P[9][23]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][23]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SKK_LOS[7]*(Kopt*P[0][0]*SKK_LOS[7] - P[23][0]*SKK_LOS[14] + Kopt*P[1][0]*SKK_LOS[6] + Kopt*P[2][0]*SKK_LOS[0] - Kopt*P[3][0]*SKK_LOS[2] + Kopt*P[10][0]*SKK_LOS[16] + Kopt*P[11][0]*a3*SKK_LOS[16] - Kopt*P[12][0]*a2*SKK_LOS[16] - Kopt*P[9][0]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][0]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SKK_LOS[6]*(Kopt*P[0][1]*SKK_LOS[7] - P[23][1]*SKK_LOS[14] + Kopt*P[1][1]*SKK_LOS[6] + Kopt*P[2][1]*SKK_LOS[0] - Kopt*P[3][1]*SKK_LOS[2] + Kopt*P[10][1]*SKK_LOS[16] + Kopt*P[11][1]*a3*SKK_LOS[16] - Kopt*P[12][1]*a2*SKK_LOS[16] - Kopt*P[9][1]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][1]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SKK_LOS[0]*(Kopt*P[0][2]*SKK_LOS[7] - P[23][2]*SKK_LOS[14] + Kopt*P[1][2]*SKK_LOS[6] + Kopt*P[2][2]*SKK_LOS[0] - Kopt*P[3][2]*SKK_LOS[2] + Kopt*P[10][2]*SKK_LOS[16] + Kopt*P[11][2]*a3*SKK_LOS[16] - Kopt*P[12][2]*a2*SKK_LOS[16] - Kopt*P[9][2]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][2]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) - Kopt*SKK_LOS[2]*(Kopt*P[0][3]*SKK_LOS[7] - P[23][3]*SKK_LOS[14] + Kopt*P[1][3]*SKK_LOS[6] + Kopt*P[2][3]*SKK_LOS[0] - Kopt*P[3][3]*SKK_LOS[2] + Kopt*P[10][3]*SKK_LOS[16] + Kopt*P[11][3]*a3*SKK_LOS[16] - Kopt*P[12][3]*a2*SKK_LOS[16] - Kopt*P[9][3]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][3]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SKK_LOS[16]*(Kopt*P[0][10]*SKK_LOS[7] - P[23][10]*SKK_LOS[14] + Kopt*P[1][10]*SKK_LOS[6] + Kopt*P[2][10]*SKK_LOS[0] - Kopt*P[3][10]*SKK_LOS[2] + Kopt*P[10][10]*SKK_LOS[16] + Kopt*P[11][10]*a3*SKK_LOS[16] - Kopt*P[12][10]*a2*SKK_LOS[16] - Kopt*P[9][10]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][10]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*a3*SKK_LOS[16]*(Kopt*P[0][11]*SKK_LOS[7] - P[23][11]*SKK_LOS[14] + Kopt*P[1][11]*SKK_LOS[6] + Kopt*P[2][11]*SKK_LOS[0] - Kopt*P[3][11]*SKK_LOS[2] + Kopt*P[10][11]*SKK_LOS[16] + Kopt*P[11][11]*a3*SKK_LOS[16] - Kopt*P[12][11]*a2*SKK_LOS[16] - Kopt*P[9][11]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][11]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) - Kopt*a2*SKK_LOS[16]*(Kopt*P[0][12]*SKK_LOS[7] - P[23][12]*SKK_LOS[14] + Kopt*P[1][12]*SKK_LOS[6] + Kopt*P[2][12]*SKK_LOS[0] - Kopt*P[3][12]*SKK_LOS[2] + Kopt*P[10][12]*SKK_LOS[16] + Kopt*P[11][12]*a3*SKK_LOS[16] - Kopt*P[12][12]*a2*SKK_LOS[16] - Kopt*P[9][12]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][12]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) - Kopt*SH_LOS[0]*SH_LOS[1]*SH_LOS[5]*(Kopt*P[0][9]*SKK_LOS[7] - P[23][9]*SKK_LOS[14] + Kopt*P[1][9]*SKK_LOS[6] + Kopt*P[2][9]*SKK_LOS[0] - Kopt*P[3][9]*SKK_LOS[2] + Kopt*P[10][9]*SKK_LOS[16] + Kopt*P[11][9]*a3*SKK_LOS[16] - Kopt*P[12][9]*a2*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SH_LOS[0]*SH_LOS[1]*SH_LOS[5]*(Kopt*P[0][22]*SKK_LOS[7] - P[23][22]*SKK_LOS[14] + Kopt*P[1][22]*SKK_LOS[6] + Kopt*P[2][22]*SKK_LOS[0] - Kopt*P[3][22]*SKK_LOS[2] + Kopt*P[10][22]*SKK_LOS[16] + Kopt*P[11][22]*a3*SKK_LOS[16] - Kopt*P[12][22]*a2*SKK_LOS[16] - Kopt*P[9][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9]*(Kopt*P[0][4]*SKK_LOS[7] - P[23][4]*SKK_LOS[14] + Kopt*P[1][4]*SKK_LOS[6] + Kopt*P[2][4]*SKK_LOS[0] - Kopt*P[3][4]*SKK_LOS[2] + Kopt*P[10][4]*SKK_LOS[16] + Kopt*P[11][4]*a3*SKK_LOS[16] - Kopt*P[12][4]*a2*SKK_LOS[16] - Kopt*P[9][4]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][4]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) + Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13]*(Kopt*P[0][5]*SKK_LOS[7] - P[23][5]*SKK_LOS[14] + Kopt*P[1][5]*SKK_LOS[6] + Kopt*P[2][5]*SKK_LOS[0] - Kopt*P[3][5]*SKK_LOS[2] + Kopt*P[10][5]*SKK_LOS[16] + Kopt*P[11][5]*a3*SKK_LOS[16] - Kopt*P[12][5]*a2*SKK_LOS[16] - Kopt*P[9][5]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][5]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]) - Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]*(Kopt*P[0][6]*SKK_LOS[7] - P[23][6]*SKK_LOS[14] + Kopt*P[1][6]*SKK_LOS[6] + Kopt*P[2][6]*SKK_LOS[0] - Kopt*P[3][6]*SKK_LOS[2] + Kopt*P[10][6]*SKK_LOS[16] + Kopt*P[11][6]*a3*SKK_LOS[16] - Kopt*P[12][6]*a2*SKK_LOS[16] - Kopt*P[9][6]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][6]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]));
            SK_LOS[1] = 1/(R_LOS - SKK_LOS[15]*(Kopt*P[1][23]*SKK_LOS[3] - Kopt*P[0][23]*SKK_LOS[4] - P[23][23]*SKK_LOS[15] + Kopt*P[2][23]*SKK_LOS[1] + Kopt*P[3][23]*SKK_LOS[5] + Kopt*P[11][23]*SKK_LOS[16] - Kopt*P[10][23]*a3*SKK_LOS[16] + Kopt*P[12][23]*a1*SKK_LOS[16] + Kopt*P[9][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SKK_LOS[4]*(Kopt*P[1][0]*SKK_LOS[3] - Kopt*P[0][0]*SKK_LOS[4] - P[23][0]*SKK_LOS[15] + Kopt*P[2][0]*SKK_LOS[1] + Kopt*P[3][0]*SKK_LOS[5] + Kopt*P[11][0]*SKK_LOS[16] - Kopt*P[10][0]*a3*SKK_LOS[16] + Kopt*P[12][0]*a1*SKK_LOS[16] + Kopt*P[9][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[3]*(Kopt*P[1][1]*SKK_LOS[3] - Kopt*P[0][1]*SKK_LOS[4] - P[23][1]*SKK_LOS[15] + Kopt*P[2][1]*SKK_LOS[1] + Kopt*P[3][1]*SKK_LOS[5] + Kopt*P[11][1]*SKK_LOS[16] - Kopt*P[10][1]*a3*SKK_LOS[16] + Kopt*P[12][1]*a1*SKK_LOS[16] + Kopt*P[9][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[1]*(Kopt*P[1][2]*SKK_LOS[3] - Kopt*P[0][2]*SKK_LOS[4] - P[23][2]*SKK_LOS[15] + Kopt*P[2][2]*SKK_LOS[1] + Kopt*P[3][2]*SKK_LOS[5] + Kopt*P[11][2]*SKK_LOS[16] - Kopt*P[10][2]*a3*SKK_LOS[16] + Kopt*P[12][2]*a1*SKK_LOS[16] + Kopt*P[9][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[5]*(Kopt*P[1][3]*SKK_LOS[3] - Kopt*P[0][3]*SKK_LOS[4] - P[23][3]*SKK_LOS[15] + Kopt*P[2][3]*SKK_LOS[1] + Kopt*P[3][3]*SKK_LOS[5] + Kopt*P[11][3]*SKK_LOS[16] - Kopt*P[10][3]*a3*SKK_LOS[16] + Kopt*P[12][3]*a1*SKK_LOS[16] + Kopt*P[9][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[16]*(Kopt*P[1][11]*SKK_LOS[3] - Kopt*P[0][11]*SKK_LOS[4] - P[23][11]*SKK_LOS[15] + Kopt*P[2][11]*SKK_LOS[1] + Kopt*P[3][11]*SKK_LOS[5] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[10][11]*a3*SKK_LOS[16] + Kopt*P[12][11]*a1*SKK_LOS[16] + Kopt*P[9][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*a3*SKK_LOS[16]*(Kopt*P[1][10]*SKK_LOS[3] - Kopt*P[0][10]*SKK_LOS[4] - P[23][10]*SKK_LOS[15] + Kopt*P[2][10]*SKK_LOS[1] + Kopt*P[3][10]*SKK_LOS[5] + Kopt*P[11][10]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[12][10]*a1*SKK_LOS[16] + Kopt*P[9][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*a1*SKK_LOS[16]*(Kopt*P[1][12]*SKK_LOS[3] - Kopt*P[0][12]*SKK_LOS[4] - P[23][12]*SKK_LOS[15] + Kopt*P[2][12]*SKK_LOS[1] + Kopt*P[3][12]*SKK_LOS[5] + Kopt*P[11][12]*SKK_LOS[16] - Kopt*P[10][12]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] + Kopt*P[9][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5]*(Kopt*P[1][9]*SKK_LOS[3] - Kopt*P[0][9]*SKK_LOS[4] - P[23][9]*SKK_LOS[15] + Kopt*P[2][9]*SKK_LOS[1] + Kopt*P[3][9]*SKK_LOS[5] + Kopt*P[11][9]*SKK_LOS[16] - Kopt*P[10][9]*a3*SKK_LOS[16] + Kopt*P[12][9]*a1*SKK_LOS[16] + Kopt*P[9][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5]*(Kopt*P[1][22]*SKK_LOS[3] - Kopt*P[0][22]*SKK_LOS[4] - P[23][22]*SKK_LOS[15] + Kopt*P[2][22]*SKK_LOS[1] + Kopt*P[3][22]*SKK_LOS[5] + Kopt*P[11][22]*SKK_LOS[16] - Kopt*P[10][22]*a3*SKK_LOS[16] + Kopt*P[12][22]*a1*SKK_LOS[16] + Kopt*P[9][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11]*(Kopt*P[1][4]*SKK_LOS[3] - Kopt*P[0][4]*SKK_LOS[4] - P[23][4]*SKK_LOS[15] + Kopt*P[2][4]*SKK_LOS[1] + Kopt*P[3][4]*SKK_LOS[5] + Kopt*P[11][4]*SKK_LOS[16] - Kopt*P[10][4]*a3*SKK_LOS[16] + Kopt*P[12][4]*a1*SKK_LOS[16] + Kopt*P[9][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]*(Kopt*P[1][5]*SKK_LOS[3] - Kopt*P[0][5]*SKK_LOS[4] - P[23][5]*SKK_LOS[15] + Kopt*P[2][5]*SKK_LOS[1] + Kopt*P[3][5]*SKK_LOS[5] + Kopt*P[11][5]*SKK_LOS[16] - Kopt*P[10][5]*a3*SKK_LOS[16] + Kopt*P[12][5]*a1*SKK_LOS[16] + Kopt*P[9][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]*(Kopt*P[1][6]*SKK_LOS[3] - Kopt*P[0][6]*SKK_LOS[4] - P[23][6]*SKK_LOS[15] + Kopt*P[2][6]*SKK_LOS[1] + Kopt*P[3][6]*SKK_LOS[5] + Kopt*P[11][6]*SKK_LOS[16] - Kopt*P[10][6]*a3*SKK_LOS[16] + Kopt*P[12][6]*a1*SKK_LOS[16] + Kopt*P[9][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]));

            Kfusion[0] = SK_LOS[0]*(Kopt*P[0][2]*SKK_LOS[0] - P[0][23]*SKK_LOS[14] + Kopt*P[0][1]*SKK_LOS[6] - Kopt*P[0][3]*SKK_LOS[2] + Kopt*P[0][10]*SKK_LOS[16] + Kopt*P[0][0]*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[6] - vd*(2*q1 + 2*a1*q0 + 2*a3*q2) + vn*(2*q3 - 2*a1*q2 + 2*a3*q0)) + SH_LOS[0]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2)) + Kopt*P[0][11]*a3*SKK_LOS[16] - Kopt*P[0][12]*a2*SKK_LOS[16] + Kopt*P[0][4]*SH_LOS[1]*SH_LOS[3]*(a3*(sq(q0) + sq(q1) - sq(q2) - sq(q3)) + 2*q0*q3 - 2*q1*q2 - a1*(2*q0*q2 + 2*q1*q3)) - Kopt*P[0][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[0][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[0][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[0][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[1] = SK_LOS[0]*(Kopt*P[1][2]*SKK_LOS[0] - P[1][23]*SKK_LOS[14] + Kopt*P[1][1]*SKK_LOS[6] + Kopt*P[1][0]*SKK_LOS[7] - Kopt*P[1][3]*SKK_LOS[2] + Kopt*P[1][10]*SKK_LOS[16] + Kopt*P[1][11]*a3*SKK_LOS[16] - Kopt*P[1][12]*a2*SKK_LOS[16] - Kopt*P[1][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[1][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[1][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[1][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[1][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[2] = SK_LOS[0]*(Kopt*P[2][2]*SKK_LOS[0] - P[2][23]*SKK_LOS[14] + Kopt*P[2][1]*SKK_LOS[6] + Kopt*P[2][0]*SKK_LOS[7] - Kopt*P[2][3]*SKK_LOS[2] + Kopt*P[2][10]*SKK_LOS[16] + Kopt*P[2][11]*a3*SKK_LOS[16] - Kopt*P[2][12]*a2*SKK_LOS[16] - Kopt*P[2][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[2][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[2][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[2][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[2][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[3] = SK_LOS[0]*(Kopt*P[3][2]*SKK_LOS[0] - P[3][23]*SKK_LOS[14] + Kopt*P[3][1]*SKK_LOS[6] + Kopt*P[3][0]*SKK_LOS[7] - Kopt*P[3][3]*SKK_LOS[2] + Kopt*P[3][10]*SKK_LOS[16] + Kopt*P[3][11]*a3*SKK_LOS[16] - Kopt*P[3][12]*a2*SKK_LOS[16] - Kopt*P[3][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[3][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[3][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[3][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[3][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[4] = SK_LOS[0]*(Kopt*P[4][2]*SKK_LOS[0] - P[4][23]*SKK_LOS[14] + Kopt*P[4][1]*SKK_LOS[6] + Kopt*P[4][0]*SKK_LOS[7] - Kopt*P[4][3]*SKK_LOS[2] + Kopt*P[4][10]*SKK_LOS[16] + Kopt*P[4][11]*a3*SKK_LOS[16] - Kopt*P[4][12]*a2*SKK_LOS[16] - Kopt*P[4][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[4][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[4][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[4][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[5] = SK_LOS[0]*(Kopt*P[5][2]*SKK_LOS[0] - P[5][23]*SKK_LOS[14] + Kopt*P[5][1]*SKK_LOS[6] + Kopt*P[5][0]*SKK_LOS[7] - Kopt*P[5][3]*SKK_LOS[2] + Kopt*P[5][10]*SKK_LOS[16] + Kopt*P[5][11]*a3*SKK_LOS[16] - Kopt*P[5][12]*a2*SKK_LOS[16] - Kopt*P[5][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[5][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[5][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[5][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[5][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[6] = SK_LOS[0]*(Kopt*P[6][2]*SKK_LOS[0] - P[6][23]*SKK_LOS[14] + Kopt*P[6][1]*SKK_LOS[6] + Kopt*P[6][0]*SKK_LOS[7] - Kopt*P[6][3]*SKK_LOS[2] + Kopt*P[6][10]*SKK_LOS[16] + Kopt*P[6][11]*a3*SKK_LOS[16] - Kopt*P[6][12]*a2*SKK_LOS[16] - Kopt*P[6][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[6][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[6][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[6][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[6][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[7] = SK_LOS[0]*(Kopt*P[7][2]*SKK_LOS[0] - P[7][23]*SKK_LOS[14] + Kopt*P[7][1]*SKK_LOS[6] + Kopt*P[7][0]*SKK_LOS[7] - Kopt*P[7][3]*SKK_LOS[2] + Kopt*P[7][10]*SKK_LOS[16] + Kopt*P[7][11]*a3*SKK_LOS[16] - Kopt*P[7][12]*a2*SKK_LOS[16] - Kopt*P[7][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[7][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[7][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[7][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[7][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[8] = SK_LOS[0]*(Kopt*P[8][2]*SKK_LOS[0] - P[8][23]*SKK_LOS[14] + Kopt*P[8][1]*SKK_LOS[6] + Kopt*P[8][0]*SKK_LOS[7] - Kopt*P[8][3]*SKK_LOS[2] + Kopt*P[8][10]*SKK_LOS[16] + Kopt*P[8][11]*a3*SKK_LOS[16] - Kopt*P[8][12]*a2*SKK_LOS[16] - Kopt*P[8][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[8][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[8][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[8][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[8][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[9] = SK_LOS[0]*(Kopt*P[9][2]*SKK_LOS[0] - P[9][23]*SKK_LOS[14] + Kopt*P[9][1]*SKK_LOS[6] + Kopt*P[9][0]*SKK_LOS[7] - Kopt*P[9][3]*SKK_LOS[2] + Kopt*P[9][10]*SKK_LOS[16] + Kopt*P[9][11]*a3*SKK_LOS[16] - Kopt*P[9][12]*a2*SKK_LOS[16] - Kopt*P[9][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[9][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[9][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[9][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[9][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[10] = SK_LOS[0]*(Kopt*P[10][2]*SKK_LOS[0] - P[10][23]*SKK_LOS[14] + Kopt*P[10][1]*SKK_LOS[6] + Kopt*P[10][0]*SKK_LOS[7] - Kopt*P[10][3]*SKK_LOS[2] + Kopt*P[10][10]*SKK_LOS[16] + Kopt*P[10][11]*a3*SKK_LOS[16] - Kopt*P[10][12]*a2*SKK_LOS[16] - Kopt*P[10][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[10][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[10][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[10][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[10][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[11] = SK_LOS[0]*(Kopt*P[11][2]*SKK_LOS[0] - P[11][23]*SKK_LOS[14] + Kopt*P[11][1]*SKK_LOS[6] + Kopt*P[11][0]*SKK_LOS[7] - Kopt*P[11][3]*SKK_LOS[2] + Kopt*P[11][10]*SKK_LOS[16] + Kopt*P[11][11]*a3*SKK_LOS[16] - Kopt*P[11][12]*a2*SKK_LOS[16] - Kopt*P[11][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[11][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[11][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[11][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[11][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[12] = SK_LOS[0]*(Kopt*P[12][2]*SKK_LOS[0] - P[12][23]*SKK_LOS[14] + Kopt*P[12][1]*SKK_LOS[6] + Kopt*P[12][0]*SKK_LOS[7] - Kopt*P[12][3]*SKK_LOS[2] + Kopt*P[12][10]*SKK_LOS[16] + Kopt*P[12][11]*a3*SKK_LOS[16] - Kopt*P[12][12]*a2*SKK_LOS[16] - Kopt*P[12][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[12][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[12][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[12][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[12][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[13] = 0.0f;//SK_LOS[0]*(Kopt*P[13][2]*SKK_LOS[0] - P[13][23]*SKK_LOS[14] + Kopt*P[13][1]*SKK_LOS[6] + Kopt*P[13][0]*SKK_LOS[7] - Kopt*P[13][3]*SKK_LOS[2] + Kopt*P[13][10]*SKK_LOS[16] + Kopt*P[13][11]*a3*SKK_LOS[16] - Kopt*P[13][12]*a2*SKK_LOS[16] - Kopt*P[13][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[13][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[13][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[13][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[13][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[14] = SK_LOS[0]*(Kopt*P[14][2]*SKK_LOS[0] - P[14][23]*SKK_LOS[14] + Kopt*P[14][1]*SKK_LOS[6] + Kopt*P[14][0]*SKK_LOS[7] - Kopt*P[14][3]*SKK_LOS[2] + Kopt*P[14][10]*SKK_LOS[16] + Kopt*P[14][11]*a3*SKK_LOS[16] - Kopt*P[14][12]*a2*SKK_LOS[16] - Kopt*P[14][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[14][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[14][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[14][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[14][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[15] = SK_LOS[0]*(Kopt*P[15][2]*SKK_LOS[0] - P[15][23]*SKK_LOS[14] + Kopt*P[15][1]*SKK_LOS[6] + Kopt*P[15][0]*SKK_LOS[7] - Kopt*P[15][3]*SKK_LOS[2] + Kopt*P[15][10]*SKK_LOS[16] + Kopt*P[15][11]*a3*SKK_LOS[16] - Kopt*P[15][12]*a2*SKK_LOS[16] - Kopt*P[15][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[15][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[15][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[15][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[15][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[16] = SK_LOS[0]*(Kopt*P[16][2]*SKK_LOS[0] - P[16][23]*SKK_LOS[14] + Kopt*P[16][1]*SKK_LOS[6] + Kopt*P[16][0]*SKK_LOS[7] - Kopt*P[16][3]*SKK_LOS[2] + Kopt*P[16][10]*SKK_LOS[16] + Kopt*P[16][11]*a3*SKK_LOS[16] - Kopt*P[16][12]*a2*SKK_LOS[16] - Kopt*P[16][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[16][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[16][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[16][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[16][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[17] = SK_LOS[0]*(Kopt*P[17][2]*SKK_LOS[0] - P[17][23]*SKK_LOS[14] + Kopt*P[17][1]*SKK_LOS[6] + Kopt*P[17][0]*SKK_LOS[7] - Kopt*P[17][3]*SKK_LOS[2] + Kopt*P[17][10]*SKK_LOS[16] + Kopt*P[17][11]*a3*SKK_LOS[16] - Kopt*P[17][12]*a2*SKK_LOS[16] - Kopt*P[17][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[17][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[17][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[17][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[17][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[18] = SK_LOS[0]*(Kopt*P[18][2]*SKK_LOS[0] - P[18][23]*SKK_LOS[14] + Kopt*P[18][1]*SKK_LOS[6] + Kopt*P[18][0]*SKK_LOS[7] - Kopt*P[18][3]*SKK_LOS[2] + Kopt*P[18][10]*SKK_LOS[16] + Kopt*P[18][11]*a3*SKK_LOS[16] - Kopt*P[18][12]*a2*SKK_LOS[16] - Kopt*P[18][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[18][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[18][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[18][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[18][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[19] = SK_LOS[0]*(Kopt*P[19][2]*SKK_LOS[0] - P[19][23]*SKK_LOS[14] + Kopt*P[19][1]*SKK_LOS[6] + Kopt*P[19][0]*SKK_LOS[7] - Kopt*P[19][3]*SKK_LOS[2] + Kopt*P[19][10]*SKK_LOS[16] + Kopt*P[19][11]*a3*SKK_LOS[16] - Kopt*P[19][12]*a2*SKK_LOS[16] - Kopt*P[19][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[19][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[19][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[19][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[19][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[20] = SK_LOS[0]*(Kopt*P[20][2]*SKK_LOS[0] - P[20][23]*SKK_LOS[14] + Kopt*P[20][1]*SKK_LOS[6] + Kopt*P[20][0]*SKK_LOS[7] - Kopt*P[20][3]*SKK_LOS[2] + Kopt*P[20][10]*SKK_LOS[16] + Kopt*P[20][11]*a3*SKK_LOS[16] - Kopt*P[20][12]*a2*SKK_LOS[16] - Kopt*P[20][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[20][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[20][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[20][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[20][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[21] = SK_LOS[0]*(Kopt*P[21][2]*SKK_LOS[0] - P[21][23]*SKK_LOS[14] + Kopt*P[21][1]*SKK_LOS[6] + Kopt*P[21][0]*SKK_LOS[7] - Kopt*P[21][3]*SKK_LOS[2] + Kopt*P[21][10]*SKK_LOS[16] + Kopt*P[21][11]*a3*SKK_LOS[16] - Kopt*P[21][12]*a2*SKK_LOS[16] - Kopt*P[21][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[21][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[21][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[21][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[21][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[22] = SK_LOS[0]*(Kopt*P[22][2]*SKK_LOS[0] - P[22][23]*SKK_LOS[14] + Kopt*P[22][1]*SKK_LOS[6] + Kopt*P[22][0]*SKK_LOS[7] - Kopt*P[22][3]*SKK_LOS[2] + Kopt*P[22][10]*SKK_LOS[16] + Kopt*P[22][11]*a3*SKK_LOS[16] - Kopt*P[22][12]*a2*SKK_LOS[16] - Kopt*P[22][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[22][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[22][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[22][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
            Kfusion[23] = SK_LOS[0]*(Kopt*P[23][2]*SKK_LOS[0] - P[23][23]*SKK_LOS[14] + Kopt*P[23][1]*SKK_LOS[6] + Kopt*P[23][0]*SKK_LOS[7] - Kopt*P[23][3]*SKK_LOS[2] + Kopt*P[23][10]*SKK_LOS[16] + Kopt*P[23][11]*a3*SKK_LOS[16] - Kopt*P[23][12]*a2*SKK_LOS[16] - Kopt*P[23][9]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[23][22]*SH_LOS[0]*SH_LOS[1]*SH_LOS[5] + Kopt*P[23][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[9] + Kopt*P[23][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[13] - Kopt*P[23][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[12]);
        ...
        else if (obsIndex == 1) // we are now fusing the Y measurement
        {
            // Calculate observation jacobians
            for (uint8_t i = 0; i < n_states; i++) H_LOS[i] = 0;
            H_LOS[0] = -Kopt*(SH_LOS[1]*SH_LOS[3]*(vd*SH_LOS[4] - ve*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*a2*q2 - 2*q0 + 2*a3*q3)) + SH_LOS[2]*SH_LOS[3]*(2*a1*q1 - 2*q0 + 2*a2*q2));
            H_LOS[1] = Kopt*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3));
            H_LOS[2] = Kopt*(SH_LOS[1]*SH_LOS[3]*(vd*(2*a2*q2 - 2*q0 + 2*a3*q3) - vn*SH_LOS[4] + ve*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q2 + 2*a2*q0 + 2*a1*q3));
            H_LOS[3] = Kopt*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0)));
            H_LOS[4] = -Kopt*SH_LOS[1]*SH_LOS[3]*(a2*(2*q0*q2 + 2*q1*q3) + a3*(2*q0*q3 - 2*q1*q2) - sq(q0) - sq(q1) + sq(q2) + sq(q3));
            H_LOS[5] = Kopt*SH_LOS[1]*SH_LOS[3]*(a3*(sq(q0) - sq(q1) + sq(q2) - sq(q3)) + 2*q0*q3 + 2*q1*q2 + a2*(2*q0*q1 - 2*q2*q3));
            H_LOS[6] = -Kopt*SH_LOS[1]*SH_LOS[3]*(a2*(sq(q0) - sq(q1) - sq(q2) + sq(q3)) + 2*q0*q2 - 2*q1*q3 - a3*(2*q0*q1 + 2*q2*q3));
            H_LOS[9] = Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5];
            H_LOS[10] = -(Kopt*a3)/dt;
            H_LOS[11] = Kopt/dt;
            H_LOS[12] = (Kopt*a1)/dt;
            H_LOS[22] = -Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5];
            H_LOS[23] = - (delAng.y - a3*(delAng.x) + a1*(delAng.z))/dt - SH_LOS[1]*SH_LOS[2]*SH_LOS[3];

            // Calculate Kalman gains
            Kfusion[0] = (Kopt*P[0][2]*SKK_LOS[1] - Kopt*P[0][0]*SKK_LOS[4] - P[0][23]*SKK_LOS[15] + Kopt*P[0][11]*SKK_LOS[16] + Kopt*P[0][1]*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3)) + Kopt*P[0][3]*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0))) - Kopt*P[0][10]*a3*SKK_LOS[16] + Kopt*P[0][12]*a1*SKK_LOS[16] + Kopt*P[0][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[0][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[0][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[0][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[0][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10])/(R_LOS - SKK_LOS[15]*(Kopt*P[2][23]*SKK_LOS[1] - Kopt*P[0][23]*SKK_LOS[4] - P[23][23]*SKK_LOS[15] + Kopt*P[11][23]*SKK_LOS[16] + Kopt*P[1][23]*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3)) + Kopt*P[3][23]*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0))) - Kopt*P[10][23]*a3*SKK_LOS[16] + Kopt*P[12][23]*a1*SKK_LOS[16] + Kopt*P[9][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][23]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][23]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[5]*(Kopt*P[1][3]*SKK_LOS[3] - Kopt*P[0][3]*SKK_LOS[4] - P[23][3]*SKK_LOS[15] + Kopt*P[2][3]*SKK_LOS[1] + Kopt*P[3][3]*SKK_LOS[5] + Kopt*P[11][3]*SKK_LOS[16] - Kopt*P[10][3]*a3*SKK_LOS[16] + Kopt*P[12][3]*a1*SKK_LOS[16] + Kopt*P[9][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][3]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][3]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[16]*(Kopt*P[1][11]*SKK_LOS[3] - Kopt*P[0][11]*SKK_LOS[4] - P[23][11]*SKK_LOS[15] + Kopt*P[2][11]*SKK_LOS[1] + Kopt*P[3][11]*SKK_LOS[5] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[10][11]*a3*SKK_LOS[16] + Kopt*P[12][11]*a1*SKK_LOS[16] + Kopt*P[9][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][11]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][11]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[3]*(Kopt*P[1][1]*SKK_LOS[3] - Kopt*P[0][1]*SKK_LOS[4] - P[23][1]*SKK_LOS[15] + Kopt*P[2][1]*SKK_LOS[1] + Kopt*P[11][1]*SKK_LOS[16] + Kopt*P[3][1]*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0))) - Kopt*P[10][1]*a3*SKK_LOS[16] + Kopt*P[12][1]*a1*SKK_LOS[16] + Kopt*P[9][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][1]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][1]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SKK_LOS[4]*(Kopt*P[2][0]*SKK_LOS[1] - Kopt*P[0][0]*SKK_LOS[4] - P[23][0]*SKK_LOS[15] + Kopt*P[11][0]*SKK_LOS[16] + Kopt*P[1][0]*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3)) + Kopt*P[3][0]*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0))) - Kopt*P[10][0]*a3*SKK_LOS[16] + Kopt*P[12][0]*a1*SKK_LOS[16] + Kopt*P[9][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][0]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][0]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SKK_LOS[1]*(Kopt*P[2][2]*SKK_LOS[1] - Kopt*P[0][2]*SKK_LOS[4] - P[23][2]*SKK_LOS[15] + Kopt*P[11][2]*SKK_LOS[16] + Kopt*P[1][2]*(SH_LOS[1]*SH_LOS[3]*(ve*SH_LOS[4] + vd*(2*q3 + 2*a2*q1 + 2*a3*q0) + vn*(2*q1 - 2*a2*q3 + 2*a3*q2)) - SH_LOS[2]*SH_LOS[3]*(2*q1 + 2*a1*q0 - 2*a2*q3)) + Kopt*P[3][2]*(SH_LOS[2]*SH_LOS[3]*(2*q3 - 2*a1*q2 + 2*a2*q1) - SH_LOS[1]*SH_LOS[3]*(ve*(2*a2*q2 - 2*q0 + 2*a3*q3) - vd*(2*q1 - 2*a2*q3 + 2*a3*q2) + vn*(2*q3 + 2*a2*q1 + 2*a3*q0))) - Kopt*P[10][2]*a3*SKK_LOS[16] + Kopt*P[12][2]*a1*SKK_LOS[16] + Kopt*P[9][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][2]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][2]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*a3*SKK_LOS[16]*(Kopt*P[1][10]*SKK_LOS[3] - Kopt*P[0][10]*SKK_LOS[4] - P[23][10]*SKK_LOS[15] + Kopt*P[2][10]*SKK_LOS[1] + Kopt*P[3][10]*SKK_LOS[5] + Kopt*P[11][10]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[12][10]*a1*SKK_LOS[16] + Kopt*P[9][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][10]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][10]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*a1*SKK_LOS[16]*(Kopt*P[1][12]*SKK_LOS[3] - Kopt*P[0][12]*SKK_LOS[4] - P[23][12]*SKK_LOS[15] + Kopt*P[2][12]*SKK_LOS[1] + Kopt*P[3][12]*SKK_LOS[5] + Kopt*P[11][12]*SKK_LOS[16] - Kopt*P[10][12]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] + Kopt*P[9][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][12]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][12]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5]*(Kopt*P[1][9]*SKK_LOS[3] - Kopt*P[0][9]*SKK_LOS[4] - P[23][9]*SKK_LOS[15] + Kopt*P[2][9]*SKK_LOS[1] + Kopt*P[3][9]*SKK_LOS[5] + Kopt*P[11][9]*SKK_LOS[16] - Kopt*P[10][9]*a3*SKK_LOS[16] + Kopt*P[12][9]*a1*SKK_LOS[16] + Kopt*P[9][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][9]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[2]*SH_LOS[5]*(Kopt*P[1][22]*SKK_LOS[3] - Kopt*P[0][22]*SKK_LOS[4] - P[23][22]*SKK_LOS[15] + Kopt*P[2][22]*SKK_LOS[1] + Kopt*P[3][22]*SKK_LOS[5] + Kopt*P[11][22]*SKK_LOS[16] - Kopt*P[10][22]*a3*SKK_LOS[16] + Kopt*P[12][22]*a1*SKK_LOS[16] + Kopt*P[9][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][22]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11]*(Kopt*P[1][4]*SKK_LOS[3] - Kopt*P[0][4]*SKK_LOS[4] - P[23][4]*SKK_LOS[15] + Kopt*P[2][4]*SKK_LOS[1] + Kopt*P[3][4]*SKK_LOS[5] + Kopt*P[11][4]*SKK_LOS[16] - Kopt*P[10][4]*a3*SKK_LOS[16] + Kopt*P[12][4]*a1*SKK_LOS[16] + Kopt*P[9][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][4]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) + Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]*(Kopt*P[1][5]*SKK_LOS[3] - Kopt*P[0][5]*SKK_LOS[4] - P[23][5]*SKK_LOS[15] + Kopt*P[2][5]*SKK_LOS[1] + Kopt*P[3][5]*SKK_LOS[5] + Kopt*P[11][5]*SKK_LOS[16] - Kopt*P[10][5]*a3*SKK_LOS[16] + Kopt*P[12][5]*a1*SKK_LOS[16] + Kopt*P[9][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][5]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]) - Kopt*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]*(Kopt*P[1][6]*SKK_LOS[3] - Kopt*P[0][6]*SKK_LOS[4] - P[23][6]*SKK_LOS[15] + Kopt*P[2][6]*SKK_LOS[1] + Kopt*P[3][6]*SKK_LOS[5] + Kopt*P[11][6]*SKK_LOS[16] - Kopt*P[10][6]*a3*SKK_LOS[16] + Kopt*P[12][6]*a1*SKK_LOS[16] + Kopt*P[9][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][6]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10] - Kopt*P[6][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8]));
            Kfusion[1] = SK_LOS[1]*(Kopt*P[1][2]*SKK_LOS[1] - Kopt*P[1][0]*SKK_LOS[4] - P[1][23]*SKK_LOS[15] + Kopt*P[1][3]*SKK_LOS[5] + Kopt*P[1][1]*SKK_LOS[3] + Kopt*P[1][11]*SKK_LOS[16] - Kopt*P[1][10]*a3*SKK_LOS[16] + Kopt*P[1][12]*a1*SKK_LOS[16] + Kopt*P[1][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[1][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[1][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[1][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[1][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[2] = SK_LOS[1]*(Kopt*P[2][2]*SKK_LOS[1] - Kopt*P[2][0]*SKK_LOS[4] - P[2][23]*SKK_LOS[15] + Kopt*P[2][3]*SKK_LOS[5] + Kopt*P[2][1]*SKK_LOS[3] + Kopt*P[2][11]*SKK_LOS[16] - Kopt*P[2][10]*a3*SKK_LOS[16] + Kopt*P[2][12]*a1*SKK_LOS[16] + Kopt*P[2][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[2][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[2][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[2][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[2][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[3] = SK_LOS[1]*(Kopt*P[3][2]*SKK_LOS[1] - Kopt*P[3][0]*SKK_LOS[4] - P[3][23]*SKK_LOS[15] + Kopt*P[3][3]*SKK_LOS[5] + Kopt*P[3][1]*SKK_LOS[3] + Kopt*P[3][11]*SKK_LOS[16] - Kopt*P[3][10]*a3*SKK_LOS[16] + Kopt*P[3][12]*a1*SKK_LOS[16] + Kopt*P[3][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[3][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[3][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[3][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[3][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[4] = SK_LOS[1]*(Kopt*P[4][2]*SKK_LOS[1] - Kopt*P[4][0]*SKK_LOS[4] - P[4][23]*SKK_LOS[15] + Kopt*P[4][3]*SKK_LOS[5] + Kopt*P[4][1]*SKK_LOS[3] + Kopt*P[4][11]*SKK_LOS[16] - Kopt*P[4][10]*a3*SKK_LOS[16] + Kopt*P[4][12]*a1*SKK_LOS[16] + Kopt*P[4][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[4][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[4][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[4][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[5] = SK_LOS[1]*(Kopt*P[5][2]*SKK_LOS[1] - Kopt*P[5][0]*SKK_LOS[4] - P[5][23]*SKK_LOS[15] + Kopt*P[5][3]*SKK_LOS[5] + Kopt*P[5][1]*SKK_LOS[3] + Kopt*P[5][11]*SKK_LOS[16] - Kopt*P[5][10]*a3*SKK_LOS[16] + Kopt*P[5][12]*a1*SKK_LOS[16] + Kopt*P[5][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[5][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[5][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[5][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[5][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[6] = SK_LOS[1]*(Kopt*P[6][2]*SKK_LOS[1] - Kopt*P[6][0]*SKK_LOS[4] - P[6][23]*SKK_LOS[15] + Kopt*P[6][3]*SKK_LOS[5] + Kopt*P[6][1]*SKK_LOS[3] + Kopt*P[6][11]*SKK_LOS[16] - Kopt*P[6][10]*a3*SKK_LOS[16] + Kopt*P[6][12]*a1*SKK_LOS[16] + Kopt*P[6][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[6][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[6][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[6][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[6][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[7] = SK_LOS[1]*(Kopt*P[7][2]*SKK_LOS[1] - Kopt*P[7][0]*SKK_LOS[4] - P[7][23]*SKK_LOS[15] + Kopt*P[7][3]*SKK_LOS[5] + Kopt*P[7][1]*SKK_LOS[3] + Kopt*P[7][11]*SKK_LOS[16] - Kopt*P[7][10]*a3*SKK_LOS[16] + Kopt*P[7][12]*a1*SKK_LOS[16] + Kopt*P[7][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[7][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[7][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[7][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[7][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[8] = SK_LOS[1]*(Kopt*P[8][2]*SKK_LOS[1] - Kopt*P[8][0]*SKK_LOS[4] - P[8][23]*SKK_LOS[15] + Kopt*P[8][3]*SKK_LOS[5] + Kopt*P[8][1]*SKK_LOS[3] + Kopt*P[8][11]*SKK_LOS[16] - Kopt*P[8][10]*a3*SKK_LOS[16] + Kopt*P[8][12]*a1*SKK_LOS[16] + Kopt*P[8][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[8][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[8][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[8][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[8][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[9] = SK_LOS[1]*(Kopt*P[9][2]*SKK_LOS[1] - Kopt*P[9][0]*SKK_LOS[4] - P[9][23]*SKK_LOS[15] + Kopt*P[9][3]*SKK_LOS[5] + Kopt*P[9][1]*SKK_LOS[3] + Kopt*P[9][11]*SKK_LOS[16] - Kopt*P[9][10]*a3*SKK_LOS[16] + Kopt*P[9][12]*a1*SKK_LOS[16] + Kopt*P[9][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[9][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[9][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[9][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[9][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[10] = SK_LOS[1]*(Kopt*P[10][2]*SKK_LOS[1] - Kopt*P[10][0]*SKK_LOS[4] - P[10][23]*SKK_LOS[15] + Kopt*P[10][3]*SKK_LOS[5] + Kopt*P[10][1]*SKK_LOS[3] + Kopt*P[10][11]*SKK_LOS[16] - Kopt*P[10][10]*a3*SKK_LOS[16] + Kopt*P[10][12]*a1*SKK_LOS[16] + Kopt*P[10][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[10][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[10][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[10][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[10][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[11] = SK_LOS[1]*(Kopt*P[11][2]*SKK_LOS[1] - Kopt*P[11][0]*SKK_LOS[4] - P[11][23]*SKK_LOS[15] + Kopt*P[11][3]*SKK_LOS[5] + Kopt*P[11][1]*SKK_LOS[3] + Kopt*P[11][11]*SKK_LOS[16] - Kopt*P[11][10]*a3*SKK_LOS[16] + Kopt*P[11][12]*a1*SKK_LOS[16] + Kopt*P[11][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[11][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[11][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[11][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[11][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[12] = SK_LOS[1]*(Kopt*P[12][2]*SKK_LOS[1] - Kopt*P[12][0]*SKK_LOS[4] - P[12][23]*SKK_LOS[15] + Kopt*P[12][3]*SKK_LOS[5] + Kopt*P[12][1]*SKK_LOS[3] + Kopt*P[12][11]*SKK_LOS[16] - Kopt*P[12][10]*a3*SKK_LOS[16] + Kopt*P[12][12]*a1*SKK_LOS[16] + Kopt*P[12][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[12][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[12][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[12][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[12][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[13] = 0.0f;//SK_LOS[1]*(Kopt*P[13][2]*SKK_LOS[1] - Kopt*P[13][0]*SKK_LOS[4] - P[13][23]*SKK_LOS[15] + Kopt*P[13][3]*SKK_LOS[5] + Kopt*P[13][1]*SKK_LOS[3] + Kopt*P[13][11]*SKK_LOS[16] - Kopt*P[13][10]*a3*SKK_LOS[16] + Kopt*P[13][12]*a1*SKK_LOS[16] + Kopt*P[13][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[13][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[13][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[13][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[13][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[14] = SK_LOS[1]*(Kopt*P[14][2]*SKK_LOS[1] - Kopt*P[14][0]*SKK_LOS[4] - P[14][23]*SKK_LOS[15] + Kopt*P[14][3]*SKK_LOS[5] + Kopt*P[14][1]*SKK_LOS[3] + Kopt*P[14][11]*SKK_LOS[16] - Kopt*P[14][10]*a3*SKK_LOS[16] + Kopt*P[14][12]*a1*SKK_LOS[16] + Kopt*P[14][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[14][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[14][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[14][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[14][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[15] = SK_LOS[1]*(Kopt*P[15][2]*SKK_LOS[1] - Kopt*P[15][0]*SKK_LOS[4] - P[15][23]*SKK_LOS[15] + Kopt*P[15][3]*SKK_LOS[5] + Kopt*P[15][1]*SKK_LOS[3] + Kopt*P[15][11]*SKK_LOS[16] - Kopt*P[15][10]*a3*SKK_LOS[16] + Kopt*P[15][12]*a1*SKK_LOS[16] + Kopt*P[15][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[15][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[15][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[15][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[15][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[16] = SK_LOS[1]*(Kopt*P[16][2]*SKK_LOS[1] - Kopt*P[16][0]*SKK_LOS[4] - P[16][23]*SKK_LOS[15] + Kopt*P[16][3]*SKK_LOS[5] + Kopt*P[16][1]*SKK_LOS[3] + Kopt*P[16][11]*SKK_LOS[16] - Kopt*P[16][10]*a3*SKK_LOS[16] + Kopt*P[16][12]*a1*SKK_LOS[16] + Kopt*P[16][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[16][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[16][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[16][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[16][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[17] = SK_LOS[1]*(Kopt*P[17][2]*SKK_LOS[1] - Kopt*P[17][0]*SKK_LOS[4] - P[17][23]*SKK_LOS[15] + Kopt*P[17][3]*SKK_LOS[5] + Kopt*P[17][1]*SKK_LOS[3] + Kopt*P[17][11]*SKK_LOS[16] - Kopt*P[17][10]*a3*SKK_LOS[16] + Kopt*P[17][12]*a1*SKK_LOS[16] + Kopt*P[17][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[17][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[17][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[17][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[17][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[18] = SK_LOS[1]*(Kopt*P[18][2]*SKK_LOS[1] - Kopt*P[18][0]*SKK_LOS[4] - P[18][23]*SKK_LOS[15] + Kopt*P[18][3]*SKK_LOS[5] + Kopt*P[18][1]*SKK_LOS[3] + Kopt*P[18][11]*SKK_LOS[16] - Kopt*P[18][10]*a3*SKK_LOS[16] + Kopt*P[18][12]*a1*SKK_LOS[16] + Kopt*P[18][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[18][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[18][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[18][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[18][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[19] = SK_LOS[1]*(Kopt*P[19][2]*SKK_LOS[1] - Kopt*P[19][0]*SKK_LOS[4] - P[19][23]*SKK_LOS[15] + Kopt*P[19][3]*SKK_LOS[5] + Kopt*P[19][1]*SKK_LOS[3] + Kopt*P[19][11]*SKK_LOS[16] - Kopt*P[19][10]*a3*SKK_LOS[16] + Kopt*P[19][12]*a1*SKK_LOS[16] + Kopt*P[19][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[19][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[19][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[19][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[19][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[20] = SK_LOS[1]*(Kopt*P[20][2]*SKK_LOS[1] - Kopt*P[20][0]*SKK_LOS[4] - P[20][23]*SKK_LOS[15] + Kopt*P[20][3]*SKK_LOS[5] + Kopt*P[20][1]*SKK_LOS[3] + Kopt*P[20][11]*SKK_LOS[16] - Kopt*P[20][10]*a3*SKK_LOS[16] + Kopt*P[20][12]*a1*SKK_LOS[16] + Kopt*P[20][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[20][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[20][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[20][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[20][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[21] = SK_LOS[1]*(Kopt*P[21][2]*SKK_LOS[1] - Kopt*P[21][0]*SKK_LOS[4] - P[21][23]*SKK_LOS[15] + Kopt*P[21][3]*SKK_LOS[5] + Kopt*P[21][1]*SKK_LOS[3] + Kopt*P[21][11]*SKK_LOS[16] - Kopt*P[21][10]*a3*SKK_LOS[16] + Kopt*P[21][12]*a1*SKK_LOS[16] + Kopt*P[21][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[21][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[21][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[21][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[21][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[22] = SK_LOS[1]*(Kopt*P[22][2]*SKK_LOS[1] - Kopt*P[22][0]*SKK_LOS[4] - P[22][23]*SKK_LOS[15] + Kopt*P[22][3]*SKK_LOS[5] + Kopt*P[22][1]*SKK_LOS[3] + Kopt*P[22][11]*SKK_LOS[16] - Kopt*P[22][10]*a3*SKK_LOS[16] + Kopt*P[22][12]*a1*SKK_LOS[16] + Kopt*P[22][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[22][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[22][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[22][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
            Kfusion[23] = SK_LOS[1]*(Kopt*P[23][2]*SKK_LOS[1] - Kopt*P[23][0]*SKK_LOS[4] - P[23][23]*SKK_LOS[15] + Kopt*P[23][3]*SKK_LOS[5] + Kopt*P[23][1]*SKK_LOS[3] + Kopt*P[23][11]*SKK_LOS[16] - Kopt*P[23][10]*a3*SKK_LOS[16] + Kopt*P[23][12]*a1*SKK_LOS[16] + Kopt*P[23][9]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[23][22]*SH_LOS[1]*SH_LOS[2]*SH_LOS[5] - Kopt*P[23][6]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[8] - Kopt*P[23][4]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[11] + Kopt*P[23][5]*SH_LOS[1]*SH_LOS[3]*SKK_LOS[10]);
        ...
        if ((innovLOS[obsIndex]*innovLOS[obsIndex]/varInnovLOS[obsIndex]) < 9.0f)
        {
            ...
            for (uint8_t i = 0; i < n_states; i++)
            {
                for (uint8_t j = 0; j < n_states; j++)
                {
                    ...
                    KHP[i][j] = KHP[i][j] + KH[i][23] * P[23][j];
                }
            }
        }
        for (uint8_t i = 0; i <  n_states; i++)
...
// Store states and delta angles in a history array along with time stamp
void AttPosEKF::StoreStates(uint64_t timestamp_ms)
{
    for (unsigned i=0; i<n_states; i++) {
        storedStates[i][storeIndex] = states[i];
    }
    for (unsigned i=n_states; i<n_storedStates; i++) {
        storedStates[i][storeIndex] = delAngForFusion[i-n_states];
    }
    //printf("delAng.x=%5.4f, delAng.y=%5.4f, delAng.z=%5.4f, index=%5.4f\n", storedStates[24][storeIndex], storedStates[25][storeIndex], storedStates[26][storeIndex],float(storeIndex));
...
{
    // reset all stored states and delta angles
    ...
    for (unsigned i = 0; i < n_storedStates; i++) {
        storedStates[i][storeIndex] = states[i];
    }
...
int AttPosEKF::RecallStates(float* statesForFusion, uint64_t msec)
{
    ...
    if (bestTimeDelta < 200) // only output stored state if < 200 msec retrieval error
    {
        ...
        //printf("delAng.x=%5.4f, delAng.y=%5.4f, delAng.z=%5.4f, index=%5.4f\n", storedStates[24][bestStoreIndex], storedStates[25][bestStoreIndex], storedStates[26][bestStoreIndex],float(bestStoreIndex));

        // recall delta angles
        for (unsigned i=n_states; i < n_storedStates; i++) {
            if (isfinite(storedStates[i][bestStoreIndex])) {
                statesForFusion[i] = storedStates[i][bestStoreIndex];
            } else if (isfinite(delAngForFusion[i-n_states])) {
                statesForFusion[i] = delAngForFusion[i-n_states];
            } else {
                // There is not much we can do here, except reporting the error we just
                // found.
                ret++;
    ...
    else // otherwise output current states and delta angles
    {
        // use current states
        for (unsigned i = 0; i < n_states; i++) {
        ...
        // use current delta angles
        for (unsigned i = n_states; i < n_storedStates; i++) {
            if (isfinite(delAngForFusion[i-n_states])) {
                statesForFusion[i] = delAngForFusion[i-n_states];
            } else {
                ret++;
            }
...
void AttPosEKF::ConstrainVariances()
{
    ...
    // Constrain optical flow scale factor variance
    P[23][23] = ConstrainFloat(P[23][23], 0.0f, 0.04f);
}
 ...
 * Reset the height state.
 *
 * This resets the terrain offset state using the curent altitude and range finder measurement
 */
void AttPosEKF::ResetTerrain(void)
{
    // write to the state vector
    states[22]  = -hgtMea + rngMea;
    terrainInitialised = true;
    printf("rngMea=%5.1f, hgtMea=%5.1f, states[22]=%5.1f\n", rngMea, hgtMea, states[22]);
...
void AttPosEKF::InitializeDynamic(float (&initvelNED)[3])
{
    ...
    states[23] = 1.0f; // optical flow scale factor
...
void AttPosEKF::ZeroVariables()
{
    ...
    for (unsigned i = 0; i < data_buffer_size; i++) {
        ...
        for (unsigned j = 0; j < n_storedStates; j++) {
