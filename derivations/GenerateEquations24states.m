...
% Estimated position of terrain along D axis (m) 
% Optical flow sensor scale factor (allows for variation in optics)
...
% XY line of sight angular rate measurements (rel to sensor frame) from a downwards looking optical flow sensor
% range to terrain measurement
...
stateVector = [q0;q1;q2;q3;vn;ve;vd;pn;pe;pd;dax_b;day_b;daz_b;dvz_b;vwn;vwe;magN;magE;magD;magX;magY;magZ;ptd;Kopt];
...
processEqns = [qNew;vNew;pNew;dabNew;dvbNew;vwnNew;vweNew;magNnew;magEnew;magDnew;magXnew;magYnew;magZnew;ptdNew;KoptNew];
...
% Error growth in other states is not defined here and is handled as part
% of the implementation using a simple error growth model with process
% noise variances defined separately for each state
distVector = [da;dv];
...
relVelSensor = transpose(Tsn)*[vn;ve;vd];
